package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1303:int = 10000;
      ...
      private var var_423:ByteArray;
      
      private var var_949:IEncryption;
      
      private var var_642:IProtocol;
      
      private var _id:String;
      
      private var var_950:IMessageClassManager;
      
      private var var_264:ICoreCommunicationManager;
      
      private var var_424:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this._id = param1;
         this.var_264 = param2;
         this.var_423 = new ByteArray();
         this.var_950 = new MessageClassManager();
         this.var_72 = new Socket();
         this.var_297 = new Timer(const_1303,1);
         this.var_297.addEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
         this.var_72.addEventListener(Event.CONNECT,this.onConnect);
         this.var_72.addEventListener(Event.COMPLETE,this.method_5);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_72)
         {
            ...
            this.var_72.removeEventListener(Event.COMPLETE,this.method_5);
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(this.var_424)
         {
            this.var_424.connectionInit(param1,param2);
         }
         Security.loadPolicyFile("xmlsocket://" + param1 + ":" + param2);
         this.var_297.start();
         this.var_641 = getTimer();
      ...
      {
         this.var_297.delay = param1;
      }
      
      public function addMessageEvent(param1:IMessageEvent) : void
      {
         this.var_264.addConnectionMessageEvent(this._id,param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_950.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            this.logConnection("Could not find registered message composer for " + param1);
            return false;
         }
         var _loc5_:ByteArray = this.var_642.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(this.var_424)
         {
            this.var_424.messageSent(String(_loc4_),_loc5_.toString());
         }
         if(this.var_949 != null)
         {
            _loc3_ = this.var_949.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      {
         this.var_950.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_642.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_642.decoder + "\n";
         return _loc1_ + ("Encryption: " + this.var_949 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_642.getMessages(this.var_423,receivedMessages);
         ...
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_424)
               {
                  this.var_424.messageReceived(String(id),data.toString());
               }
               this.logConnection(">>[SOCKET IN] timestamp:" + getTimer() + " Received message id: " + id + " data: " + data.toString());
               eventClasses = this.var_950.getMessageEventClasses(id);
               events = new Array();
               for each(eventClass in eventClasses)
               {
                  eventsForClass = this.var_264.getMessageEvents(this,eventClass);
               ...
               for each(messageEventInstance in events)
               {
                  ...
                  else
                  {
                     ...
                     if(parserClass != parserClassCurrent)
                     {
                        ...
                        parserInstance = this.var_264.getMessageParser(parserClass);
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(this.var_423,offset);
               this.var_423 = temp;
               this.logConnection("[SOCKET REST] offset: " + offset + " rest: " + this.var_423.toString());
            }
         }
         catch(e:Error)
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_423.writeByte(this.var_72.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_297.stop();
         this.var_1457 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_641));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_1457 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_641));
         dispatchEvent(param1);
      }
      ...
      private function method_5(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_641));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_641));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_641));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_641));
         var _loc2_:IOErrorEvent = new IOErrorEvent(IOErrorEvent.IO_ERROR);
         _loc2_.text = "Socket Timeout (" + this.var_297.delay + " ms). Possible Firewall.";
