package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_999:String = "AssetLibraryReady";
      
      public static const const_623:String = "AssetLibraryLoaded";
      
      public static const const_1263:String = "AssetLibraryUnloaded";
      
      public static const const_1491:String = "AssetLibraryLoadError";
      
      private static var var_285:Dictionary;
      
      private static var _lazyAssetProcessor:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_498:uint = 0;
      
      private static var var_910:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         this.var_499 = new Dictionary(false);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_910.splice(var_910.indexOf(this),1);
            --var_498;
            this.var_499 = null;
            this.var_912 = null;
            this.var_148 = null;
      ...
      {
         if(this._file == param1.url && this.var_909)
         {
            if(!this.var_911 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_733,this.var_613);
            }
            this.var_911 = param2;
            dispatchEvent(new Event(AssetLibrary.const_999));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         this.var_909 = false;
         this._file = null;
         dispatchEvent(new Event(AssetLibrary.const_1263));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_912[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_499[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1024,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1106,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_895,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_499[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_499[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_30:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_402;
                     this.var_404.push(struct.assetName);
                  }
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_499[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return param1 < this.var_404.length ? this.getAssetByName(this.var_404[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_148)
         {
            ...
            {
               return this.var_404.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_148[param1] != null || (this.var_613 != null ? this.var_613[param1] != null : false);
      }
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_148)
            {
               if(this.var_148[_loc2_] == param1)
               {
                  this.var_404.splice(this.var_404.indexOf(_loc2_),1);
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_733 = _loc2_.manifest.copy();
         this.var_613 = _loc2_.resource;
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1491));
         this.var_39 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_733.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               ...
               if(_loc3_.attribute("name").toString() == param1)
               {
                  ...
                  _loc5_.setUnknownContent(this.var_613[param1]);
