package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_459:uint = 0;
      ...
      private var var_1572:AssetTypeDeclaration;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_459 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_108 is BitmapDataAsset)
         {
            ...
            this.var_1247 = BitmapDataAsset(this.var_108).var_1247;
            this.var_1246 = BitmapDataAsset(this.var_108).var_1246;
            if(this._bitmap != null)
            {
               this.var_108 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1247 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1246 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
