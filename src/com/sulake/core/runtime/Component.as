package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1658:uint = 1;
      
      public static const COMPONENT_FLAG_CONTEXT:uint = 2;
      
      public static const const_951:uint = 4;
       
      
      protected var var_668:uint = 0;
      ...
      private var var_451:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_451 = new InterfaceStructList();
      ...
      {
         var _loc3_:InterfaceStruct = this.var_451.getStructByInterface(param1);
         if(_loc3_ == null)
         {
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = this.var_451.getStructByInterface(param1);
         if(_loc2_ == null)
         {
         ...
         if(this.var_1405 & const_951)
         {
            if(_loc3_ == 0)
            {
               if(this.var_451.getTotalReferenceCount() == 0)
               {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_668 + "]";
      }
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc7_:uint = this.var_451.length;
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
            _loc6_ = this.var_451.getStructByIndex(_loc8_);
