package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1159:String = "asset-libraries";
      ...
      private var var_307:LibraryLoaderQueue;
      
      private var var_224:Profiler;
      
      private var var_661:IEventDispatcher;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         {
            this.var_435.push(new Array());
            this.var_538.push(0);
            _loc3_++;
         }
         this.var_1526 = getTimer();
         attachComponent(this,[new IIDCore()]);
         var_408.addEventListener(Event.ENTER_FRAME,this.onEnterFrame);
         switch(param2 & 0)
         {
            case Core.const_1000:
            ...
            case Core.const_1287:
               ...
               var_408.addChild(new ProfilerViewer(this.var_224));
               break;
      ...
      {
         return this.var_307.length;
      }
      
      public function getNumberOfFilesLoaded() : uint
      {
         return this.var_436 - this.getNumberOfFilesPending();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            while(_loc3_ < CoreComponentContext.const_141)
            {
               _loc2_ = this.var_435[_loc3_] as Array;
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_661 = loadingEventDelegate;
         if(this.var_307 == null)
         {
            this.var_307 = new LibraryLoaderQueue(_debug);
         }
         try
         {
         ...
         {
            error("Failed to parse asset libraries from config xml!",true,Core.const_286,e);
         }
         try
         {
         ...
         {
            error("Failed to parse interfaces from config xml!",true,Core.const_286,e);
         }
         try
         {
         ...
         {
            error("Failed to parse components from config xml!",true,Core.const_286,e);
         }
         if(!disposed)
         {
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1420);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_661)
         {
            this.var_661.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_661)
         {
            ...
            this.var_661.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_661)
                  {
                     this.var_661.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_436 - this.var_307.length,this.var_436,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:Array = this.var_435[param2] as Array;
         _loc3_.push(param1);
      }
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         {
            _loc3_ = this.var_435[_loc4_] as Array;
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         this.var_437(_loc2_,_loc2_ - this.var_1526);
      ...
      private function simpleFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         {
            this.var_538[criticality] = 0;
            receivers = this.var_435[criticality];
            index = 0;
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(criticality < CoreComponentContext.const_141)
         {
            ...
            {
               if(this.var_538[criticality] < criticality)
               {
                  ++this.var_538[criticality];
                  skip = true;
               }
            }
            if(!skip)
      ...
      private function debugFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(_loc3_ < CoreComponentContext.const_141)
         {
            this.var_538[_loc3_] = 0;
            _loc4_ = this.var_435[_loc3_];
            _loc7_ = 0;
