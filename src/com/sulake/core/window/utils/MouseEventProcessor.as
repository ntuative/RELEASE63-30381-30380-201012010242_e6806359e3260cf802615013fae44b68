package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_762:IWindowContextStateListener;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_79 = param1.var_1147 as WindowController;
         this._lastClickTarget = param1.var_1148 as WindowController;
         this.var_147 = param1.renderer;
         this.var_762 = param1.var_1145;
         param2.begin();
         ...
         while(true)
         {
            ...
            if(_loc3_.stageX != this.var_622.x || _loc3_.stageY != this.var_622.y)
            {
               this.var_622.x = _loc3_.stageX;
               this.var_622.y = _loc3_.stageY;
               _loc6_ = new Array();
               this.var_128.groupParameterFilteredChildrenUnderPoint(this.var_622,_loc6_,WindowParam.const_27);
            }
            ...
            if(_loc4_ == 0)
            {
               ...
               {
                  if(this.var_79 != this.var_128 && !this.var_79.disposed)
                  {
                     ...
                     this.var_79 = WindowController(this.var_128);
                  }
               }
            }
            while(--_loc4_ > -1)
               ...
               if(_loc5_ != null && _loc5_.visible)
               {
                  ...
                  else if(_loc3_.type == MouseEvent.MOUSE_UP || _loc3_.type == MouseEvent.CLICK)
                  {
                     if(this.var_79 && !this.var_79.disposed)
                     {
                        ...
                        {
                           this.var_762.mouseEventReceived(_loc3_.type,this.var_79);
                        }
                     }
                  }
         ...
         param1.var_1147 = this.var_79;
         param1.var_1148 = this._lastClickTarget;
         param1.renderer = this.var_147;
         param1.var_1145 = this.var_762;
      }
