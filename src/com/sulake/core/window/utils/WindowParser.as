package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1604:String = "_INCLUDE";
      
      public static const const_1663:String = "_TEMP";
      
      private static const const_1223:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1222:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_1406:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this._typeStringToCodeTable,this.var_1167);
         this.var_928 = new Dictionary();
         this.var_1406 = new Dictionary();
         ParamCodeTable.fillTables(this.var_928,this.var_1406);
         this.var_1876 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1222,"");
         return param1.replace(const_1223,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1406)
            {
               delete this.var_1406[_loc1_];
            }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:String = "";
         var _loc3_:String = this.var_1167[param1.type];
