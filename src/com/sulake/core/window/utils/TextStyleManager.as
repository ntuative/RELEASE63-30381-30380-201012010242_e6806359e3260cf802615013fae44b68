package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_374:String = "regular";
      ...
      private static const const_551:String = "}";
      
      private static const const_1206:String = "/*";
      
      private static const const_1207:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_82[const_374],var_82[ITALIC],var_82[BOLD]];
            var_82.reset();
            var_82[const_374] = _loc5_[0];
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_551);
         if(countSubStrings(param1,TAG_OPEN) != countSubStrings(param1,const_551))
         {
            throw new Error("Mismatching amount of \"" + TAG_OPEN + "\" versus \"" + const_551 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1206) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1207) + 2,_loc5_.length);
            }
