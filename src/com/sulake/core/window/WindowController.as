package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_955:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      protected static const const_1113:String = "_COLORIZE";
      
      protected static const const_1510:String = "_IGNORE_INHERITED_STYLE";
      
      private static var var_1200:Point = new Point();
      ...
      protected var var_753:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_657 = _loc13_.blend;
            var_412 = _loc13_.treshold;
      ...
      {
         return this.var_753 != null ? this.var_753 : (this.var_13 != null ? this.var_13.procedure : this.nullEventProc);
      }
      ...
      {
         var_413 = param1;
         var_215 = !!var_413 ? uint(var_215 | var_511) : uint(var_215 & 16777215);
      ...
      {
         var_757 = param1;
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_408,this,null));
      }
      
      public function set color(param1:uint) : void
      {
         var_511 = param1 & 4278190080;
         var_215 = !!var_413 ? uint(param1) : uint(param1 & 16777215);
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_74);
      }
      ...
      {
         var_511 = param1 << 24;
         var_215 = !!var_413 ? uint(var_511 | var_215) : uint(16777215 & var_215);
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_74);
      }
      
      public function set blend(param1:Number) : void
      {
         var_657 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_1011);
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         {
            var_78 = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_526,this,null));
         }
      }
      ...
      {
         var_412 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this.var_13 != param1)
         {
            ...
            if(this.var_13 != null)
            {
               this.var_300 = this.var_13.rectangle.clone();
               var_56.x = var_11.x;
               var_56.y = var_11.y;
               var_56.width = var_11.width;
               var_56.height = var_11.height;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_453,this,this.var_13));
            }
            else
            {
               this.var_300.x = 0;
               this.var_300.y = 0;
               this.var_300.width = 0;
               this.var_300.height = 0;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_1046,this,_loc2_));
            }
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_790,var_11);
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_78,var_19,var_16,var_11,null,this.var_753,this.properties,var_758.concat(),_id) as WindowController;
         _loc2_.var_412 = var_412;
         _loc2_.var_150 = this.var_150;
         _loc2_._debug = this._debug;
         _loc2_.var_300 = this.var_300.clone();
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2019 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_945,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_571,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_394,this,null));
            }
            if(_loc6_)
            {
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = 0;
         if(!testParamFlag(WindowParam.const_742))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_40:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_885;
                  if(testParamFlag(WindowParam.const_359))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_203))
                        {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_180:
                  ...
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_415,this,null));
                     if(testParamFlag(WindowParam.const_173,WindowParam.const_156))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_166,WindowParam.const_144))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this.var_13 != null)
               ...
               case WindowNotifyEvent.const_394:
                  var_16.invalidate(this,var_11.union(var_56),WindowRedrawFlag.const_498);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1068,this,null));
                     if(this.var_13 != null)
                     {
                        this.var_13.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_294,this.var_13,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_350:
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_732,this,null));
                     if(this.var_13 != null)
                     {
                        this.var_13.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_210,this.var_13,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_532:
                  var_16.invalidate(this,var_11,WindowRedrawFlag.const_940);
                  break;
               case WindowNotifyEvent.const_526:
                  _loc6_ = new Array();
                  ...
                  while(--_loc7_ > -1)
                  {
                     ...
                     if(_loc8_.tags.indexOf(const_1510) == -1)
                     {
                        _loc8_.style = var_78;
                     }
                  }
               ...
               case WindowNotifyEvent.const_408:
                  if(!(var_19 & 0))
                  {
                     if(!this.var_21)
                     {
                        ...
                        var_16.invalidate(this,var_11,WindowRedrawFlag.const_498);
                     }
                  }
                  else if(var_19 & 0)
                  {
               ...
               case WindowNotifyEvent.const_415:
                  this.var_13.getRegionProperties(null,this.var_300);
                  this.updateScaleRelativeToParent();
                  break;
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_886:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1324:
               _loc2_ = "null";
               _loc4_ = true;
               break;
         ...
         if(_loc2_ == WindowEvent.const_150)
         {
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_412);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_412);
      }
         ...
         if(this.var_150 && var_412 > 0)
         {
            if(!testParamFlag(WindowParam.const_31))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1200,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1200,param3,param1)) : false;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_123,WindowParam.const_156);
         var _loc2_:* = !testParamFlag(WindowParam.const_131,WindowParam.const_144);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this.var_13.width - this.var_300.width;
            ...
            if(_loc2_)
            {
               _loc4_ = this.var_13.height - this.var_300.height;
               _loc5_ = uint(var_19 & 0);
               if(_loc5_ == WindowParam.const_360)
               {
                  _loc3_.height += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_352)
               {
                  _loc3_.y += _loc4_;
               }
      ...
      {
         if(_state == WindowState.const_480)
         {
            return true;
         }
         _state = WindowState.const_480;
         ...
         _loc1_.type = WindowNotifyEvent.const_1108;
         this.update(this,_loc1_);
         this.dispose();
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1201 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1201 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_700,this,param1));
         return param1;
      }
