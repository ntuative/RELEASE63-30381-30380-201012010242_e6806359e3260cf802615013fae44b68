package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1116:Dictionary = createPropertySetterTable();
      
      protected static const ZERO_RECT:Rectangle = new Rectangle();
      
      protected static const const_1513:Array = [AntiAliasType.ADVANCED,AntiAliasType.NORMAL];
      
      protected static const const_1511:Array = [GridFitType.PIXEL,GridFitType.NONE,GridFitType.SUBPIXEL];
      
      protected static const const_1512:Array = [TextFieldAutoSize.NONE,TextFieldAutoSize.LEFT,TextFieldAutoSize.RIGHT,TextFieldAutoSize.CENTER];
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_369,this.var_193);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_369 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_369,param1.var_193);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_374);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_1040 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_369);
      }
      ...
      {
         this.var_755 = param1;
         this._field.scrollH = this.var_755 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_755 * this.maxScrollH,this.var_506 * this.maxScrollV,width,height);
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(this.var_409 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_11.x,var_11.y,_loc5_ + _loc1_,Math.floor(this._field.height) + _loc2_);
               _loc6_ = true;
            }
            else if(this.var_409 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_11.x,var_11.y,_loc5_ + _loc1_,Math.floor(this._field.height) + _loc2_);
               _loc6_ = true;
            }
            else if(this.var_409 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(this.var_409 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_11.x,var_11.y,_loc5_ + _loc1_,Math.floor(this._field.height) + _loc2_);
               _loc6_ = true;
            }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:Object = TextStyleManager.getStyle(this.var_369);
         _loc1_.push(new PropertyStruct("font_face",this.defaultTextFormat.font,PropertyStruct.const_88,this.defaultTextFormat.font != _loc2_.fontFamily));
         ...
         _loc1_.push(new PropertyStruct("text_color",this._field.textColor,PropertyStruct.const_165,this._field.textColor != _loc2_.color));
         _loc1_.push(new PropertyStruct("antialias_type",this._field.antiAliasType,PropertyStruct.const_88,this._field.antiAliasType != AntiAliasType.ADVANCED,const_1513));
         ...
         _loc1_.push(new PropertyStruct("grid_fit_type",this._field.gridFitType,PropertyStruct.const_88,this._field.gridFitType != GridFitType.PIXEL,const_1511));
         ...
         _loc1_.push(new PropertyStruct("restrict",this._field.restrict,PropertyStruct.const_88,this._field.restrict != null));
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_211,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("text_style",this.var_369,PropertyStruct.const_88,this.var_369 != TextStyleManager.const_374,STYLE_SHEET_RANGE));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_211,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("auto_size",this.var_409,PropertyStruct.const_88,this.var_409 != TextFieldAutoSize.NONE,const_1512));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_211,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
