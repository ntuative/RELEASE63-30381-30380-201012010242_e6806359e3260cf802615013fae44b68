package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1233:String = "_SELECTOR";
      
      private static const const_1232:String = "_CONTENT";
       
      
      protected var var_929:ITabSelectorWindow;
      
      protected var var_1877:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_929 = findChildByTag(const_1233) as ITabSelectorWindow;
            if(this.var_929 != null)
            {
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_1877 = findChildByTag(const_1232) as IWindowContainer;
         }
      ...
      {
         return !!this.var_628 ? this.selector.iterator : null;
      }
