package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1021:IItemListWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_379)
         {
            this.var_379.removeEventListener(WindowEvent.const_288,this.scrollBarEventProc);
            this.var_379.removeEventListener(WindowEvent.const_248,this.scrollBarEventProc);
            this.var_379 = null;
         }
         if(this.var_1021)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1021)
         {
            this.var_1021 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_379)
         {
            this.var_379 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_379)
            {
               this.var_379.addEventListener(WindowEvent.const_288,this.scrollBarEventProc);
               this.var_379.addEventListener(WindowEvent.const_248,this.scrollBarEventProc);
            }
         }
         return this.var_379;
      }
