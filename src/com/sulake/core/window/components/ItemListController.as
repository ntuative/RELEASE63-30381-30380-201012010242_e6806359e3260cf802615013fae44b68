package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected static const const_1112:String = "scale_to_fit_items";
      
      protected static const const_1111:String = "resize_on_item_update";
      
      protected static const const_1109:String = "auto_arrange_items";
      
      protected static const DEF_SPACING:int = 0;
      
      protected static const const_1508:Boolean = false;
      
      protected static const DEF_RESIZE_ON_ITEM_UPDATE:Boolean = false;
      
      protected static const const_1509:Boolean = true;
      ...
      protected var var_1860:Boolean = false;
      ...
      protected var var_2643:Number = 0.0;
      
      protected var var_922:Boolean = true;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_150 = var_413 || !testParamFlag(WindowParam.const_31);
         this._container = var_16.create("_CONTAINER","",WindowType.const_369,WindowStyle.const_713,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         ...
         this.resizeOnItemUpdate = this.var_1152;
      }
      ...
      {
         return new Rectangle(this.var_619 * this.maxScrollH,this.var_618 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_619)
         {
            ...
            dispatchEvent(new WindowEvent(WindowEvent.const_411,this,null));
         }
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            this.var_618 = param1;
            this._container.y = -this.var_618 * this.maxScrollV;
            var_16.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_74);
            dispatchEvent(new WindowEvent(WindowEvent.const_411,this,null));
         }
      }
      ...
      {
         this.var_2643 = Math.max(param1,0);
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_163:
               if(this.var_1151)
               {
                  this.var_1154 = this.var_1861 - _loc3_;
                  this.var_1153 = this.var_1859 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1154 != 0 && this.var_98 != 0)
                     {
                        this.scrollH += this.var_1154 / this.var_98;
                     }
                  }
                  else if(this.var_1153 != 0 && this.var_90 != 0)
                  {
                     this.scrollV += this.var_1153 / this.var_90;
                  }
                  this.var_1861 = _loc3_;
                  this.var_1859 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_167:
               if(this.var_1151)
               {
                  ...
                  {
                     var_16.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1153);
                  }
                  this.var_1151 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_922 && !this.var_505 && this._container)
         {
            this.var_505 = true;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1110,this._spacing,PropertyStruct.const_54,this._spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1109,this.var_922,PropertyStruct.const_51,this.var_922 != const_1509));
         _loc1_.push(new PropertyStruct(const_1112,this.var_504,PropertyStruct.const_51,this.var_504 != const_1508));
         _loc1_.push(new PropertyStruct(const_1111,this.var_1152,PropertyStruct.const_51,this.var_1152 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_1111:
                  ...
                  break;
               case const_1109:
                  this.var_922 = _loc2_.value as Boolean;
                  break;
            }
         }
