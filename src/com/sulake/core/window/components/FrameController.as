package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1179:String = "_HEADER";
      
      private static const const_1180:String = "_CONTENT";
      
      private static const const_1178:String = "_SCALER";
      
      private static const const_839:String = "margin_left";
      
      private static const const_840:String = "margin_top";
      
      private static const const_842:String = "margin_right";
      
      private static const const_841:String = "margin_bottom";
       
      
      private var _title:ITextWindow;
      
      private var var_1237:IHeaderWindow;
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1237 = findChildByTag(const_1179) as IHeaderWindow;
            if(!this.var_1237)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_166 = findChildByTag(const_1180) as IWindowContainer;
            if(!this.var_166)
            {
      ...
      {
         return findChildByTag(const_1178) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1113,_loc2_,false);
      ...
      private function setupScaling() : void
      {
         ...
         var _loc4_:Boolean = testParamFlag(WindowParam.const_202);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_839,_loc3_.left,PropertyStruct.const_54,_loc2_));
         _loc1_.push(new PropertyStruct(const_840,_loc3_.top,PropertyStruct.const_54,_loc2_));
         _loc1_.push(new PropertyStruct(const_842,0 - _loc3_.right,PropertyStruct.const_54,_loc2_));
         _loc1_.push(new PropertyStruct(const_841,0 - _loc3_.bottom,PropertyStruct.const_54,_loc2_));
         return _loc1_;
      }
