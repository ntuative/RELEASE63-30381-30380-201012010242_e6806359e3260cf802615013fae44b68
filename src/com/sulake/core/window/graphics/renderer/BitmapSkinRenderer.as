package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_759:Dictionary;
      
      protected var var_760:Dictionary;
      
      private var var_861:Matrix;
      
      public function BitmapSkinRenderer(param1:String)
      {
         super(param1);
         this.var_759 = new Dictionary(false);
         this.var_760 = new Dictionary(false);
         this.var_861 = new Matrix();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            super.dispose();
            this.var_861 = null;
            for(_loc1_ in this.var_759)
            {
               _loc2_ = this.var_759[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_759[_loc1_];
            }
            this.var_759 = null;
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc18_ < _loc9_)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  _loc13_.x += param3.x;
                  _loc13_.y += param3.y;
                  if(_loc11_.scaleH == SkinLayoutEntity.const_307)
                  {
                     _loc13_.x += _loc16_;
                  }
                  else if(_loc11_.scaleH == SkinLayoutEntity.const_493)
                  {
                     _loc14_ = true;
                  ...
                  else if(_loc11_.scaleH == SkinLayoutEntity.const_265)
                  {
                     _loc14_ = true;
                     _loc13_.right += _loc16_;
                     if(_loc13_.width < 1)
                  ...
                  if(_loc11_.scaleV == SkinLayoutEntity.const_307)
                  {
                     _loc13_.y += _loc17_;
                  }
                  else if(_loc11_.scaleV == SkinLayoutEntity.const_493)
                  {
                     _loc15_ = true;
                  ...
                  else if(_loc11_.scaleV == SkinLayoutEntity.const_265)
                  {
                     _loc15_ = true;
                     _loc13_.bottom += _loc17_;
                     if(_loc13_.height < 1)
                  ...
                  else if(_loc11_.scaleV == SkinLayoutEntity.const_265 || _loc11_.scaleH == SkinLayoutEntity.const_265)
                  {
                  ...
                  {
                     this.var_861.a = _loc13_.width / _loc19_.width;
                     this.var_861.d = _loc13_.height / _loc19_.height;
                     _loc32_ = new BitmapData(_loc13_.width,_loc13_.height,false);
                     _loc32_.draw(_loc19_,this.var_861);
                     _loc33_ = new BitmapData(_loc13_.width,_loc13_.height,true,0);
                     _loc33_.draw(_loc20_,this.var_861,null);
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = this.var_759[_loc3_];
         if(_loc4_ == null)
         {
