package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1469:uint = 0;
      
      public static const const_790:uint = 1;
      
      public static const const_1034:uint = 2;
      
      public static const const_706:uint = 4;
      
      public static const const_1378:uint = 8;
      
      public static const const_1300:uint = 16;
      
      public static const const_1782:uint = 64;
      
      public static const const_1623:uint = 128;
      
      public static const const_882:uint = 256;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            case GraphicContext.const_790:
               ...
               break;
            case GraphicContext.const_1034:
         ...
         if(this.var_754)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_1863,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_1863,16777215);
                  }
                  var_289 += bitmap.width * bitmap.height * 4;
               }
