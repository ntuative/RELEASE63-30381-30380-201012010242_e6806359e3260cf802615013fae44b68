package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1169:String = "skin";
      
      private static const const_1171:String = "bitmap";
      
      private static const const_1174:String = "fill";
      
      private static const const_1170:String = "text";
      
      private static const const_1168:String = "shape";
      
      private static const const_1172:String = "unknown";
      
      private static const const_1173:String = "ServiceManager";
      ...
      private var var_2175:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2175 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1540,this.var_2175);
         this.var_2173 = new Dictionary();
         this.var_2174 = new Dictionary();
         StateCodeTable.fillTables(this.var_2173,this.var_2174);
         this.var_452 = new Dictionary();
         this.var_452[const_1169] = BitmapSkinRenderer;
         this.var_452[const_1171] = BitmapDataRenderer;
         this.var_452[const_1174] = FillSkinRenderer;
         this.var_452[const_1170] = TextSkinRenderer;
         this.var_452[const_1168] = ShapeSkinRenderer;
         this.var_452[const_1172] = SkinRenderer;
         this.var_452[const_1173] = NullSkinRenderer;
         if(var_290 == null)
         {
            var_290 = new Array();
            var_290.push(WindowState.const_62);
            var_290.push(WindowState.const_70);
            var_290.push(WindowState.const_83);
            var_290.push(WindowState.const_50);
            var_290.push(WindowState.WINDOW_STATE_HOVERING);
            var_290.push(WindowState.const_77);
            var_290.push(WindowState.const_95);
            var_290.push(WindowState.const_89);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  this.addSkinRenderer(this.var_1540[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_810[param1] == null)
         {
            this.var_810[param1] = new Array(const_838);
         }
         this.var_810[param1][param2] = param3;
         if(this.var_809[param1] == null)
         {
            this.var_809[param1] = new Array(const_838);
         }
         this.var_809[param1][param2] = param4;
      }
      ...
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         ...
         if(_loc3_)
         {
            ...
            if(!_loc4_ && param2 != WindowStyle.const_268)
            {
               _loc4_ = _loc3_["null"];
            }
         }
