package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private var var_1813:ProfilerOutput;
      
      private var var_1390:ProfilerAgentTask;
      
      private var var_1389:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_907 = new SkinContainer(_loc4_.content as XML,assets);
         this._windowRenderer = new WindowRenderer(this.var_907);
         this.var_186 = new Array(const_392);
         ...
         {
            this.var_186[_loc6_] = new WindowContext("layer_" + _loc6_,this._windowRenderer,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_225 = this.var_186[const_1235];
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         this.var_225.getMouseCursor().defineCustomCursorType(MouseCursorType.const_329,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         this.var_225.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1355,_loc7_);
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1813)
            {
               this.var_1813 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_1813.profiler = _loc3_;
            this.var_1390 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1390);
            this.var_1389 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1389);
            this.var_1135 = true;
         }
      }
      ...
      {
         return this.var_225.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_225.getWindowParser().windowToXMLString(param1);
      }
      ...
      {
         return this.var_907.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      {
         return this.var_186[param1].getDesktopWindow().getChildAt(this.var_225.getDesktopWindow().numChildren - 1);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1436,new Date().getTime().toString());
