package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1187:Number = 25;
      
      private static const const_1186:Number = 90;
      
      private static const const_870:int = 50;
      
      private static const const_1218:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1322:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_704 = new Timer(const_1187);
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_329[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_870 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_870 || param1.desktop.height - param1.y < const_1218;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1322.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_329.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1322.getIconLoc(param1.iconId);
      ...
      {
         return this.var_583[this.var_585.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_585[this.var_583.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_585.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_585.splice(_loc3_,1);
      ...
      public function removeItem(param1:String) : void
      {
         if(this.var_329.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               this.var_329.splice(this.var_329.indexOf(param1),1);
            }
         }
      }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_329.length)
         {
            _loc2_ = this._itemList[this.var_329[_loc7_]];
            if(_loc2_.active)
            {
