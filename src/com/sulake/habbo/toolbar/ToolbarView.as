package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_481:String = "LEFT";
      ...
      private var var_1332:Number = 0;
      
      private var var_1718:Number = 15;
      
      private var var_1719:Number = 5;
      
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         this.var_2628 = new Array();
         ...
         this.var_203 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_55,HabboWindowStyle.const_1030,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1095 = String(_loc6_.relocate_by_drag.@state) == "true";
         if(this.var_1095)
         {
         ...
         this.var_1094 = _loc6_.toolbar.@margin_top;
         this.var_1332 = _loc6_.toolbar.@margin_bottom;
         this.var_1718 = _loc6_.toolbar.@min_group_margin;
         this.var_1719 = _loc6_.toolbar.@margin_to_extrabar;
         ...
         this.createGroupsFromXmlList(_loc7_,this.var_244,param1,param2,this._window,this.var_274);
         this.createGroupsFromXmlList(_loc8_,this.var_589,param1,param2,this.var_203,this.var_274);
         this.alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_146,this.var_481,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_481);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_146,this.var_481);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_146,this.var_481);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < this.var_589.length)
         {
            _loc2_ = this.var_589[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      private function alignWindows() : void
      {
         ...
         if(this._window == null || this.var_203 == null)
         {
            return;
         }
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_203.x = this.var_146 + this.var_1719;
               this.var_203.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_203.x = 0;
               this.var_203.y = this.var_146 + this.var_1719;
         ...
         _loc4_ -= this.var_1332;
         _loc4_ -= this.var_1094;
         var _loc5_:* = 0;
         _loc2_ = 0;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1094;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_244.length > 1)
            {
               if(this.orientation == "LEFT" || this.orientation == "RIGHT")
               {
                  _loc6_ = Number(Math.max(this.var_1718,(this._window.height - _loc5_ * _loc8_ - this.var_1094 - this.var_1332) / (this.var_244.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1718,(this._window.width - _loc5_ * _loc8_ - this.var_1094 - this.var_1332) / (this.var_244.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_244.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_481;
