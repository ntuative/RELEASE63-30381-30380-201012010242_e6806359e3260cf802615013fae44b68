package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         this.var_1383 = param1.loop;
         if(param1.background != null)
         {
            this.var_901 = this.getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         if(_loc9_.length() > 0)
         {
            ...
            while(_loc10_ < _loc9_.length())
            {
               ...
               if(_loc8_ != null)
               {
                  this.var_904.push(_loc11_);
                  this.var_902.push(_loc8_);
               }
               _loc10_++;
            }
         }
         else
         {
            ...
            if(_loc8_ != null)
            {
               this.var_904.push(new XML());
               this.var_902.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            this.var_902[this._frame] = param6.clone();
         }
      ...
      {
         if(this.var_1383 == true || this.var_903 == 0)
         {
            if(this.var_904.length > 0)
            {
               ++this._frame;
               if(this._frame >= this.var_904.length)
               {
                  this._frame = 0;
                  ++this.var_903;
               }
      ...
      {
         return this.var_1383 == false && this.var_903 == 1 && this.var_1632 != this._state;
      }
      ...
      private function updateAssetInWindow(param1:IBitmapWrapperWindow) : void
      {
         ...
         {
            _loc2_ = this.var_902[this._frame];
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         {
            _loc3_ = new BitmapData(Math.max(param2.width,this.var_901.width),Math.max(param2.height,this.var_901.height));
            _loc3_.copyPixels(this.var_901,this.var_901.rect,new Point(0,0));
