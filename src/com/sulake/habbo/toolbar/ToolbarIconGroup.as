package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      {
         return this.var_1355.indexOf(param1) > -1;
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = this.var_2484.elements("menu");
         var _loc5_:int = 0;
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_1353.length)
         {
            _loc2_ = this.var_721.indexOf(this.var_1353[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = this.var_275[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(this.var_940 + _loc3_);
                  _loc3_ += this.var_1354;
               }
            }
            _loc4_++;
         }
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return this.var_275[this.var_721.indexOf(param1)];
      }
