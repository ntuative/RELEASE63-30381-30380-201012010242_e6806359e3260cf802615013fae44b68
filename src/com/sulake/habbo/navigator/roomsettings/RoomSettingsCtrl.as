package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1048:ICheckBoxWindow;
      
      private var var_1045:ICheckBoxWindow;
      
      private var var_562:ICheckBoxWindow;
      ...
      private var var_1638:IWindowContainer;
      ...
      {
         if(param1 != this.var_317 || this.var_1044 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1044 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1277)
         {
            this.var_688.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1314)
         {
            this.var_688.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1344)
         {
            this.var_1050.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1357)
         {
            this.setTagError(this.var_856,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_854,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1242)
         {
            this.setTagError(this.var_856,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         ...
         {
            this.var_688.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_420,this.onDoorModePasswordSelect);
         ...
         this.var_688 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1050 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_856 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_854 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_855 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1043 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1049 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1048 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1045 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_562 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1636 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1293 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1042 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1046 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1638 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1292 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_235 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1047 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2315 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2314 = ITextWindow(this._window.findChildByName("advanced_caption"));
         this.var_1637 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1637.procedure = this.onSwitchView;
         this.var_1047.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1636.visible = this._inRoom;
         this.var_1638.visible = this._inRoom;
         this.var_2314.visible = this.var_466;
         this.var_2315.visible = !this.var_466;
         if(this.var_466)
         {
            this.var_1046.visible = true;
            this.var_1292.visible = false;
            this.refreshFlatControllers();
            this.var_1046.height = Util.getLowestPoint(this.var_1046) + 4;
         }
         else
         {
            this.populateForm();
            ...
            this.var_1042.height = Util.getLowestPoint(this.var_1042) + 4;
         }
         this.var_1637.text = !!this.var_466 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1636.name,this.var_1293.name,this.var_1042.name,this.var_1046.name,this.var_1292.name,this.var_1638.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_688.setText(_loc1_.name);
         this.var_1050.setText(_loc1_.description);
         ...
         this.setTag(this.var_856,_loc1_.tags[0]);
         this.setTag(this.var_854,_loc1_.tags[1]);
         if(this.var_1049)
         {
            if(_loc1_.allowPets)
            {
               this.var_1049.select();
            }
            else
            {
               this.var_1049.unselect();
            }
         }
         if(this.var_1048)
         {
            ...
            {
               this.var_1048.select();
            }
            else
            {
               this.var_1048.unselect();
            }
         }
         if(this.var_1045)
         {
            ...
            {
               this.var_1045.select();
            }
            else
            {
               this.var_1045.unselect();
            }
         }
         if(this.var_562)
         {
            ...
            {
               this.var_562.unselect();
            }
            _loc6_ = 1;
            _loc7_ = 16777215;
            if(!this.hideWallsAllowed())
            {
               this.var_562.disable();
               _loc6_ = 0.5;
               _loc7_ = 8421504;
            }
            else
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_688.getText();
         _loc2_.description = this.var_1050.getText();
         ...
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_113)
         {
            ...
            _loc9_ = this.var_1043.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_855.clearErrors();
               this.var_1043.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1049.isSelected;
         _loc2_.allowFoodConsume = this.var_1048.isSelected;
         _loc2_.allowWalkThrough = this.var_1045.isSelected;
         _loc2_.hideWalls = this.var_562.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_856,_loc2_.tags);
         this.addTag(this.var_854,_loc2_.tags);
         this.clearErrors();
         this.var_1044 = _loc2_.roomId;
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_55,HabboWindowStyle.const_35,HabboWindowParam.const_61,new Rectangle(0,0,100,20)));
      }
