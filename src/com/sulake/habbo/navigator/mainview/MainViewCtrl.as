package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      private static const const_857:int = 1;
      
      private static const const_548:int = 2;
      
      private static const const_858:int = 3;
      
      private static const const_1198:int = 4;
      ...
      private var var_838:PopularTagsListCtrl;
      
      private var var_839:GuestRoomListCtrl;
      
      private var var_1024:OfficialRoomListCtrl;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_838 = new PopularTagsListCtrl(this._navigator);
         this.var_839 = new GuestRoomListCtrl(this._navigator);
         this.var_1024 = new OfficialRoomListCtrl(this._navigator);
      ...
      private function prepare() : void
      {
         ...
         this.var_226 = ITabContextWindow(this.var_17.findChildByName("tab_context"));
         if(!this.var_226)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _tabContext is null!");
         }
         this.var_166 = IWindowContainer(this.var_17.findChildByName("tab_content"));
         this.var_198 = IWindowContainer(this.var_17.findChildByName("custom_content"));
         this.var_179 = IWindowContainer(this.var_17.findChildByName("list_content"));
         this.var_228 = IWindowContainer(this.var_17.findChildByName("custom_footer"));
         this.var_1264 = this.var_17.findChildByName("loading_text");
         var _loc1_:IWindow = this.var_17.findChildByTag("close");
         _loc1_.procedure = this.onWindowClose;
         this.var_1026 = IRegionWindow(this.var_17.findChildByName("to_hotel_view"));
         if(!this.var_1026)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _toHotelView is null!");
         }
         this.var_1026.procedure = this.onHotelView;
         this.refreshToHotelViewButton(false);
         this.var_17.procedure = this.onWindow;
         for each(_loc2_ in this._navigator.tabs.tabs)
         {
            _loc3_ = this.var_226.getTabItemByID(_loc2_.id);
            if(!_loc3_)
            {
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1336,true);
      }
      ...
      public function refresh() : void
      {
         ...
         Util.moveChildrenToColumn(this.var_166,["custom_content","list_content"],this.var_198.y,8);
         this.var_179.height = this.var_179.height + _loc1_ - this.var_179.y - this.var_228.height + this.var_2265;
         Util.moveChildrenToColumn(this.var_166,["list_content","custom_footer"],this.var_179.y,0);
         this.var_2265 = this.var_228.height;
      ...
      {
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         var _loc2_:ISelectableWindow = this.var_226.selector.getSelected();
         if(_loc1_.button != _loc2_)
         {
            this.var_1596 = true;
            this.var_226.selector.setSelected(_loc1_.button);
         }
      }
      ...
      private function refreshCustomContent() : void
      {
         ...
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         _loc1_.tabPageDecorator.refreshCustomContent(this.var_198);
         if(Util.hasVisibleChildren(this.var_198))
         {
      ...
      {
         this.refreshList(param1,param2,this.var_839,"guest_rooms");
      }
      
      private function refreshPopularTags(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_838,"popular_tags");
      }
      
      private function refreshOfficialRooms(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_1024,"official_rooms");
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_555 == const_857)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_179.blend - _loc2_));
            this.var_179.blend = _loc3_;
            this.var_198.blend = !!this.var_1025 ? Number(_loc3_) : Number(1);
            this.var_228.blend = !!this.var_1025 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_555 = const_548;
            }
         }
         else if(this.var_555 == const_548)
         {
            if(this.var_1265 % 10 == 1)
            {
               this.var_1264.visible = !this.var_1264.visible;
            }
            ++this.var_1265;
            if(!this._navigator.data.isLoading())
            {
               this.var_555 = const_858;
            }
         }
         else if(this.var_555 == const_858)
         {
            this.refresh();
            this.var_555 = const_1198;
         }
         else
         {
      ...
      {
         this._navigator.refreshButton(this.var_1026,"icon_hotelview",!param1,null,0);
         this._navigator.refreshButton(this.var_1026,"icon_hotelview_reactive",param1,null,0);
      }
