package com.sulake.habbo.navigator
{
   ...
   public class TextFieldManager
   {
      ...
      public function TextFieldManager(param1:HabboNavigator, param2:ITextFieldWindow, param3:int = 1000, param4:Function = null, param5:String = null)
      {
         ...
         this.var_2343 = this.var_69.textBackground;
         this._orgTextBackgroundColor = this.var_69.textBackgroundColor;
         this.var_2342 = this.var_69.textColor;
      }
      ...
      {
         this.var_69.textBackground = this.var_2343;
         this.var_69.textBackgroundColor = this._orgTextBackgroundColor;
         this.var_69.textColor = this.var_2342;
      }
      ...
      public function goBackToInitialState() : void
      {
         ...
         {
            this.var_69.text = this.var_1329;
            this.var_567 = true;
         }
         else
         {
      ...
      {
         return !this.var_567 && Util.trim(this.getText()).length > 2;
      }
      ...
      private function onInputClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_69.text = this.var_2341;
         this.var_567 = false;
         this.restoreBackground();
      }
      ...
      private function checkMaxLen(param1:Event) : void
      {
         ...
         if(_loc2_.length > this.var_1657)
         {
            this.var_69.text = _loc2_.substring(0,this.var_1657);
         }
      }
   }
}
