package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function onFlatCreated(param1:IMessageEvent) : void
      {
         ...
         this._navigator.mainViewCtrl.reloadRoomList(Tabs.const_199);
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         Logger.log("Got subscription info: " + _loc2_.productName + ", " + _loc2_.method_2 + ", " + _loc2_.memberPeriods + ", " + _loc2_.periodsSubscribedAhead + ", " + _loc2_.responseType);
         this.data.hcMember = _loc2_.method_2 > 0;
      }
