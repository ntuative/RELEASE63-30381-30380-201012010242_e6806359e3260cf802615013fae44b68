package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_1078:RoomCreateViewCtrl;
      ...
      private var var_2664:Dictionary;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_578 = new RoomInfoViewCtrl(this);
         this.var_1078 = new RoomCreateViewCtrl(this);
         this.var_1909 = new RoomThumbnailRenderer(this);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_303,HabboWindowStyle.const_38,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_578.registerToolbarEvents();
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_270.startSearch(Tabs.const_201,Tabs.const_326,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_270.startSearch(Tabs.const_302,Tabs.const_199);
         this.var_399.getTab(Tabs.const_302).tabPageDecorator.tabSelected();
      }
