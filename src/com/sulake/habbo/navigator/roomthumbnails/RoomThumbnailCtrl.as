package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_1830:IButtonWindow;
      
      private var var_1828:IButtonWindow;
      
      private var var_1829:IButtonWindow;
      
      private var var_2574:IWindowContainer;
      
      private var var_2575:IWindowContainer;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1830 = IButtonWindow(this.find("bg_tab"));
         this.var_1828 = IButtonWindow(this.find("top_tab"));
         this.var_1829 = IButtonWindow(this.find("obj_tab"));
         this.var_2574 = IWindowContainer(this.find("tile_grid"));
         this.var_2575 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_1830,this.onBgTabButton);
         Util.setProcDirectly(this.var_1828,this.onTopTabButton);
         Util.setProcDirectly(this.var_1829,this.onObjTabButton);
      }
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_63.mode = ThumbnailEditorModel.const_36;
         this.reload();
      }
      ...
      private function onTopTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_63.mode = ThumbnailEditorModel.const_57;
         this.reload();
      }
      ...
      {
         this.setEnabled(this.var_1830,this.var_63.mode != ThumbnailEditorModel.const_36);
         this.setEnabled(this.var_1828,this.var_63.mode != ThumbnailEditorModel.const_57);
         this.setEnabled(this.var_1829,this.var_63.mode != ThumbnailEditorModel.const_33);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2575;
         Util.hideChildren(_loc1_);
         this.refreshEditImg(_loc1_,"edit_bg",this.var_63.mode == ThumbnailEditorModel.const_36);
         this.refreshEditImg(_loc1_,"edit_top",this.var_63.mode == ThumbnailEditorModel.const_57);
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2574;
         _loc1_.visible = true;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(this._navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_55,HabboWindowStyle.const_35,HabboWindowParam.const_61,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_303,HabboWindowStyle.const_38,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
