package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_702,RoomWidgetEcotronBoxOpenMessage.const_689,RoomWidgetEcotronBoxOpenedMessage.const_1465];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_702:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_689:
