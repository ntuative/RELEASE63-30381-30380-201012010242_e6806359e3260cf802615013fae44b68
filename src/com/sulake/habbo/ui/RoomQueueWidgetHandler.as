package com.sulake.habbo.ui
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetRoomQueueMessage.const_676);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomQueueMessage.CHANGE_TO_SPECTATOR_QUEUE:
               this._container.roomSession.changeQueue(RoomSessionQueueEvent.const_890);
               break;
            case RoomWidgetRoomQueueMessage.const_676:
               this._container.roomSession.changeQueue(RoomSessionQueueEvent.const_908);
               break;
            case RoomWidgetRoomQueueMessage.const_588:
               if(this._container.catalog != null)
               {
                  this._container.catalog.openCatalogPage(CatalogPageName.const_162,true);
               }
         }
         return null;
      }
      ...
      {
         return [RoomSessionQueueEvent.const_432];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_432:
               ...
               {
                  case RoomSessionQueueEvent.const_908:
                     _loc3_ = "null";
                     break;
                  case RoomSessionQueueEvent.const_890:
                     _loc3_ = "null";
               }
               if(_loc3_ == null)
               {
               ...
               if(_loc7_.length > 1)
               {
                  if(_loc6_ && _loc2_.queueTypes.indexOf(RoomSessionQueueEvent.const_1072) != -1)
                  {
                     _loc8_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1072) + 1;
                     _loc9_ = true;
                  }
                  else
                  {
