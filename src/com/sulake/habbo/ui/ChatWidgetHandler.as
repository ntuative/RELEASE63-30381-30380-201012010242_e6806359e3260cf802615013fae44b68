package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener
   {
      ...
      private var var_965:Number = 0.0;
      
      private var var_651:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_362 != null)
         {
            ...
            {
               _loc2_ = this.var_362.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_671,RoomWidgetChatSelectAvatarMessage.const_686];
      }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_256)
                           {
                              _loc13_ = this.var_362.getValue(_loc16_) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_361.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_795.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_256:
                                 ...
                                 if(_loc10_.type == RoomObjectTypeEnum.const_256)
                                 {
                                    if(_loc13_ != null)
                                    {
                                       this.var_362.add(_loc17_.getFigure().getFigureString(),_loc13_);
                                    }
                                 }
                                 ...
                                 if(_loc12_ != 0)
                                 {
                                    this.var_795.add(_loc16_,_loc12_);
                                 }
                                 if(_loc17_ != null)
                                 {
                                    _loc17_.dispose();
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_965 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_965);
            }
            if(this.var_651 == null)
            {
               ...
               this.var_433.y = 0;
               this.var_433.z = 0;
               this.var_651 = _loc4_.getScreenPoint(this.var_433);
               this.var_965 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_433.x = 0;
            this.var_433.y = 0;
            this.var_433.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_433);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_651.x || _loc8_.y != this.var_651.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_651,_loc5_));
