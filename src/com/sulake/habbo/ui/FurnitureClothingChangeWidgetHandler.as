package com.sulake.habbo.ui
{
   ...
   public class FurnitureClothingChangeWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver
   {
      ...
      private static const const_1142:String = "hr-165-45.hd-208-2.ch-250-64.lg-285-82.sh-290-64";
      
      private static const const_1143:String = "hr-681-41.hd-620-9.ch-879-90.lg-700-85.sh-735-68";
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_805,RoomWidgetClothingChangeMessage.const_381,RoomWidgetAvatarEditorMessage.const_336];
      }
            ...
            case RoomWidgetClothingChangeMessage.const_381:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(this._container.avatarEditor.openEditor(_loc7_.window,this,[AvatarEditorFigureCategory.const_247,AvatarEditorFigureCategory.const_626],true))
                     {
                        _loc11_ = 0;
