   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_145,this.onUserTags);
            ...
            if(this._container.roomSessionManager != null)
            {
               ...
               this._container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_147,this.onPetInfo);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_145,this.onUserTags);
         ...
         if(this._container.roomSessionManager != null)
         {
            ...
            this._container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_147,this.onPetInfo);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_693.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = this.var_693.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_785);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_622);
         _loc1_.push(RoomWidgetFurniActionMessage.const_714);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_641);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1305);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            else if(param1.type == RoomWidgetUserActionMessage.const_349 || param1.type == RoomWidgetUserActionMessage.const_488 || param1.type == RoomWidgetUserActionMessage.const_402)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_630:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_990,_loc3_.name);
               this._container.events.dispatchEvent(_loc8_);
               break;
            case RoomWidgetUserActionMessage.const_785:
            ...
            case RoomWidgetUserActionMessage.const_402:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_622:
            ...
            case RoomWidgetUserActionMessage.const_349:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_641:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_WALLITEM:
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_380);
                  if(param1.category == RoomObjectCategoryEnum.const_28)
                  {
                     _loc23_ = this._container.sessionDataManager.getFloorItemData(_loc22_);
                  }
                  else if(param1.category == RoomObjectCategoryEnum.OBJECT_CATEGORY_WALLITEM)
                  {
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1042);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_973);
               _loc6_.expiration = _loc9_ - (getTimer() - _loc10_) / 60000;
               _loc6_.isWallItem = param1.category == RoomObjectCategoryEnum.OBJECT_CATEGORY_WALLITEM;
            ...
            case RoomObjectCategoryEnum.const_34:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_256)
               {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_251)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_603);
                  ...
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_896;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1283);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = this.var_693.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = this._container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_47);
            this.var_693.add(_loc2_.petId,_loc5_);
         }
         if(_loc5_ == null)
         {
         ...
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_603);
