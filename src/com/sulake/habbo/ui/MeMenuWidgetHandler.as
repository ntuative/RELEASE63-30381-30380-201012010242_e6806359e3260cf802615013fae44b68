   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_812,this.onFigureUpdate);
            }
         ...
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_812,this.onFigureUpdate);
         ...
         {
            (this._inventory as Component).events.addEventListener(HabboInventoryEffectsEvent.const_1065,this.onAvatarEffectsChanged);
            (this._inventory as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_1093,this.onHabboClubSubscriptionChanged);
         }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1382)
            {
               ...
               this.var_1382 = _loc3_;
               this.var_1805 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1805;
            }
         }
         ...
         if(_loc2_ != null)
         {
            ...
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1021,HabboToolbarIconEnum.MEMENU);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_600);
         _loc1_.push(RoomWidgetDanceMessage.const_776);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_617);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_743);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_655);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_638);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_762);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_640);
         _loc1_.push(RoomWidgetStopEffectMessage.const_567);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1332);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_995);
         _loc1_.push(RoomWidgetToolbarMessage.const_584);
         _loc1_.push(RoomWidgetToolbarMessage.const_620);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_336);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1454);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_959);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_730);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_712);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_705);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1342);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_614);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_727);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_712:
               ...
               break;
            case RoomWidgetWaveMessage.const_600:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_776:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_617:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_743:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_655:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_640:
               ...
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1033)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_162,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_762:
               ...
               if(this._inventory != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_988:
                        this._catalog.openCatalogPage(CatalogPageName.const_1443,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1035:
                     ...
                     case RoomWidgetOpenInventoryMessage.const_1320:
                        ...
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1472:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_638:
            case RoomWidgetStopEffectMessage.const_567:
            ...
            case RoomWidgetSetToolbarIconMessage.const_1013:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_995:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_730:
               if(this._container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_584:
               ...
               break;
            case RoomWidgetToolbarMessage.const_620:
               ...
               {
                  this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_468,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_336:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_705:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_314,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_614:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_314,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_727:
            ...
            case RoomWidgetAvatarEditorMessage.const_711:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_407));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_381:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_726));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_786));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_533:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_445));
         }
      }
