package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_707);
         _loc2_.refreshViews();
      ...
      public function onClubStatus(param1:IMessageEvent) : void
      {
         ...
         {
            this._inventory.setClubStatus(_loc2_.periodsSubscribedAhead,_loc2_.method_2,_loc2_.hasEverBeenMember,_loc2_.isVIP);
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_278);
      }
      ...
      {
         var _loc2_:* = null;
         if(this._inventory.isInventoryCategoryInit(InventoryCategory.const_340))
         {
