package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_756:int = 0;
      
      protected var var_620:BitmapData;
      
      protected var var_2450:int;
      
      protected var var_1401:Boolean;
      
      protected var var_1866:Boolean;
      
      protected var var_2586:BitmapData;
      
      private const const_1812:int = 8947848;
      
      private const const_1811:int = 13421772;
      
      private const const_1541:Number = 1;
      
      private const const_1540:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_1867 = param8;
         this.var_1539 = param9;
         if(param10 != null)
         {
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1539));
         }
         else
         {
            _loc1_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_1867);
         }
         if(_loc1_.id > 0)
         {
            this.setLoadingImage(_loc1_.data);
            this.var_756 = _loc1_.id;
         }
         else
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1540;
               _loc1_.blend = this.const_1540;
            }
            else
            {
               this._window.blend = this.const_1541;
               _loc1_.blend = this.const_1541;
            }
         }
         if(this.isSelected)
         {
            this._window.color = this.const_1812;
         }
         else
         {
            this._window.color = this.const_1811;
         }
         ...
         if(_loc5_)
         {
            if(this.var_1866 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2586;
               _loc5_.visible = true;
            }
            else
            {
