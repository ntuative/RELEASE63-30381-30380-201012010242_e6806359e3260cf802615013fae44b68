package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_972:IRoomSession;
      ...
      private const const_1829:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_20 != null)
         {
            this.var_20.events.removeEventListener(RoomSessionEvent.const_84,this.roomSessionEventHandler);
            this.var_20.events.removeEventListener(RoomSessionEvent.const_94,this.roomSessionEventHandler);
            this.var_20.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_485,this.roomSessionEventHandler);
      ...
      {
         return TradingModel(this.var_47.getValue(InventorySubCategory.const_275));
      }
      
      public function get effectsModel() : EffectsModel
      {
         return EffectsModel(this.var_47.getValue(InventoryCategory.const_707));
      }
      
      public function get badgesModel() : BadgesModel
      {
         return BadgesModel(this.var_47.getValue(InventoryCategory.const_278));
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(this.var_47.getValue(InventoryCategory.const_327));
      }
      ...
      {
         return PetsModel(this.var_47.getValue(InventoryCategory.const_149));
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return this.var_47.getValue(InventoryCategory.const_340) as MarketplaceModel;
      }
      ...
      {
         this.var_354 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_20.events.addEventListener(RoomSessionEvent.const_84,this.roomSessionEventHandler);
         this.var_20.events.addEventListener(RoomSessionEvent.const_94,this.roomSessionEventHandler);
         this.var_20.events.addEventListener(RoomSessionPropertyUpdateEvent.const_485,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_94:
               this.var_972 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_485:
               this.petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_354 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_20 || !this._toolbar)
         {
            return;
         }
         ...
         this.var_47.add(InventoryCategory.const_340,_loc1_);
         ...
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_354);
         this.var_47.add(InventoryCategory.const_278,_loc3_);
         ...
         this.var_47.add(InventoryCategory.const_707,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_354);
         this.var_47.add(InventoryCategory.const_327,_loc5_);
         ...
         this.var_47.add(InventorySubCategory.const_275,_loc6_);
         ...
         this.var_47.add(InventoryCategory.const_149,_loc8_);
         this.var_174 = true;
         if(this.var_2519)
         {
            this.requestData();
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_887.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_887.indexOf(param1);
            if(_loc3_ >= 0)
            {
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_1829);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_1065));
      }
