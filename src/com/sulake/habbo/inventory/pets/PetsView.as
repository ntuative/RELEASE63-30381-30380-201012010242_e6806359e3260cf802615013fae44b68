package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener
   {
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         this.var_447 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         this.updateGrid();
         this.updatePreview(this.var_291);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_515.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_447.removeGridItem(_loc2_.window);
         if(this.var_291 == _loc2_)
         {
            this.var_291 = null;
            this.selectFirst();
         }
      ...
      {
         if(this.var_515 == null || this.var_515.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_515.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_515.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            this.var_447.addGridItem(_loc2_.window);
            this.var_515.add(param1.id,_loc2_);
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_291.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_291 != null)
         {
            this.var_291.setSelected(false);
         }
         this.var_291 = param1;
         if(this.var_291 != null)
         {
            this.var_291.setSelected(true);
         }
