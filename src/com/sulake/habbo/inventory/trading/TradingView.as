package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_856:uint = 4284532064;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_178)
            {
               this.var_178.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_178.stop();
               this.var_178 = null;
            }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1591 = this.createMinimizedWindow();
         }
         if(!this.var_2243)
         {
            return this.var_66;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_66)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.ownUserAccepts ? uint(const_856) : uint(const_855);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.otherUserAccepts ? uint(const_856) : uint(const_855);
            }
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_178 = new Timer(1000,3);
            this.var_178.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_178.reset();
         this.var_178.repeatCount = 3;
         this.var_178.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_178.currentCount));
         if(this.var_178.currentCount == 3)
         {
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_1084)
            {
            ...
            this.var_380.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_472);
            this.var_380.show();
         }
