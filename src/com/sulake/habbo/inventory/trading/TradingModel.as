package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_49.updateItemList(this.var_727);
         this.var_49.updateItemList(this.var_1368);
      ...
      public function close() : void
      {
         if(this.var_680)
         {
            if(this._state != const_170 && this._state != const_243)
            {
               this.requestCancelTrading();
               this.state = TradingModel.TRADING_STATE_CANCELLED;
            }
            this.state = const_170;
            this._inventory.toggleInventorySubPage(InventorySubCategory.const_983);
            this.var_680 = false;
         }
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_726 + " OTHER: " + this.var_1121);
         ...
         {
            case const_170:
               if(param1 == const_186 || param1 == const_243)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_49.alertPopup(TradingView.const_1105);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_727)
            {
               this.var_726 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1121 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_49.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_727)
            {
               this.var_49.alertPopup(TradingView.const_1005);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_282.length < const_1275)
         {
