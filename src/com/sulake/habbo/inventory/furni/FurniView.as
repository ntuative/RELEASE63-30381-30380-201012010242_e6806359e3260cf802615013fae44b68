package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_836:int = 1;
      
      private const const_1523:int = 2;
      
      private const const_1524:int = 3;
      
      private const const_1555:int = 42;
      
      private const const_1556:int = 120;
      ...
      private var var_635:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         this.var_485.add(FurniModel.const_41,new FurniGridView(this.var_63,FurniModel.const_41,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_485.add(FurniModel.const_45,new FurniGridView(this.var_63,FurniModel.const_45,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_485.getValue(this.var_398);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_63.getCategoryContent(this.var_398);
         if(!this.var_63.isListInited())
         {
            _loc2_ = this.const_836;
         }
         ...
         {
            _loc2_ = this.const_1524;
         }
         if(this.var_1908 == _loc2_)
         {
            return;
         }
         this.var_1908 = _loc2_;
         ...
         switch(_loc2_)
         {
            case this.const_836:
               ...
               break;
            case this.const_1523:
               _loc3_.visible = false;
               _loc4_.visible = true;
               _loc5_.visible = false;
               break;
            case this.const_1524:
               _loc3_.visible = false;
               _loc4_.visible = false;
               _loc5_.visible = true;
      ...
      public function clearViews() : void
      {
         ...
         while(_loc4_ < _loc1_.length)
         {
            ...
            _loc3_ = this.var_485.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_485.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_485.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_63.getGroupItemInIndex(_loc3_,this.var_398);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            if(_loc5_.category == FurniCategory.const_328)
            {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_635 && this.var_635.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1556)
         {
            _loc3_ = this.const_1556;
         }
         else if(_loc3_ < this.const_1555)
         {
            _loc3_ = this.const_1555;
         }
         else
         {
         ...
         else if(param1.type == WindowEvent.const_59)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_315);
            }
         }
      }
   }
