package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_315:String = "pets";
      
      private static const const_1219:int = 100;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog)
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_227,this.onObjectPlaced);
         this._catalog = param7;
         this.var_592 = new Timer(const_1219,1);
         ...
         this.var_2430 = XML(_loc9_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_227,this.onObjectPlaced);
               }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_328)
         {
         ...
         if(this.var_872 == null)
         {
            this.var_872 = this._windowManager.buildFromXML(this.var_2430) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_872.clone() as IWindowContainer;
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_340);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_482.add(const_41,new Array());
         this.var_482.add(const_45,new Array());
         if(this._view != null)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_313 || _loc3_.category == FurniCategory.const_328 || _loc3_.category == FurniCategory.const_347)
         {
            if(param1)
            {
               return false;
      ...
      {
         if(this.var_1334 && param1.type == RoomEngineObjectEvent.const_227)
         {
            this.var_1334 = false;
         }
      }
      ...
      {
         return this.var_482.getValue(param1);
      }
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_275:
               ...
               break;
            case InventorySubCategory.const_983:
               this.removeAllLocks();
               if(this._view != null)
               {
                  this._view.updateActionView();
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = this.var_482.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = this.var_482.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
