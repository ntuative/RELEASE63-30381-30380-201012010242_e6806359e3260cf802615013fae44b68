package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager
   {
      ...
      private var var_490:Number = 1.0;
      ...
      private var var_606:PlayListController;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_1028,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         if(_loc2_ == null)
         {
            ...
            this.var_891.add(param1,_loc2_);
         }
         _loc2_.volume = this.var_490;
         _loc2_.play();
      }
      ...
      public function loadTraxSong(param1:int, param2:String) : IHabboSound
      {
         ...
         var _loc5_:* = [];
         var _loc6_:Array = this.var_728.getKeys();
         var _loc7_:int = 0;
         ...
         var _loc8_:TraxSequencer = new TraxSequencer(param1,_loc3_,this.var_728,events);
         _loc8_.volume = this.var_490;
         this.var_892 = null;
         this.var_729 = -1;
         if(_loc5_.length != 0)
         {
      ...
      {
         if(this.var_169 == null || this._connection == null || this._roomEngine == null || this.var_606 != null)
         {
            return;
         }
         this.var_606 = new PlayListController(this,events,this._roomEngine.events,this._connection);
      }
      ...
      private function onSampleLoadComplete(param1:Event) : void
      {
         ...
         this.var_728.add(_loc3_,_loc6_);
         if(this.var_605.length == 0 && this.var_729 != -1)
         {
            this.var_892.ready = true;
            events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1028,this.var_729));
            this.var_729 = -1;
            this.var_892 = null;
         }
      }
      ...
      private function onTraxLoadComplete(param1:Event) : void
      {
         ...
         this.var_606.checkSongPlayState(_loc2_.id);
      }
      
      private function ioErrorHandler(param1:Event) : void
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1323,this.var_729));
         this.var_729 = -1;
         this.var_892 = null;
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            this.setHabboToolbarIconState(this.var_490 > 0);
            return;
         }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_490 * 100)));
         }
      }
      ...
      {
         this.var_490 = param1;
         this.var_606.updateVolume(this.var_490);
