package com.sulake.habbo.sound
{
   ...
   public class PlayListController implements IDisposable
   {
      ...
      private const const_1809:String = "type_sound_machine";
      
      private const const_1529:String = "type_jukebox";
      
      private var var_516:HabboSoundManagerFlash10;
      ...
      public function PlayListController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this._events.addEventListener(SoundCompleteEvent.const_745,this.onSongFinishedPlayingEvent);
         this.var_87.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_663,this.onSoundMachinePlayEvent);
         this.var_87.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_783,this.onSoundMachineStopEvent);
         this.var_87.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_579,this.onJukeboxInitEvent);
         this.var_87.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_430,this.onDisposeEvent);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._events)
            {
               this._events.removeEventListener(SoundCompleteEvent.const_745,this.onSongFinishedPlayingEvent);
               this._events = null;
            }
            if(this.var_87)
            {
               this.var_87.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_663,this.onSoundMachinePlayEvent);
               this.var_87.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_783,this.onSoundMachineStopEvent);
               this.var_87.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_579,this.onJukeboxInitEvent);
               this.var_87.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_430,this.onDisposeEvent);
               this.var_87 = null;
            }
            if(this.var_366)
            {
      ...
      {
         this.startPlaying(this.const_1809);
      }
      ...
      {
         this.startPlaying(this.const_1529);
      }
      ...
      public function startPlaying(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.var_265 = _loc2_.id;
            this.playSong(this.var_265);
         }
      }
      ...
      {
         var _loc1_:IHabboSound = this.var_366[this.var_265] as IHabboSound;
         if(_loc1_ != null)
         {
            _loc1_.stop();
         }
      ...
      {
         var _loc2_:IHabboSound = this.var_366.getValue(this.var_265) as IHabboSound;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function playSong(param1:int) : void
      {
         ...
         _loc2_.volume = this.var_516.volume;
         _loc2_.play();
         if(_loc3_.length >= 4)
         {
            this.var_516.notifyPlayedSong(_loc3_.name,_loc3_.creator);
         }
         var _loc5_:PlayListEntry = this.getNextEntry();
         if(_loc5_ != null && _loc5_.id != this.var_265)
         {
      ...
      {
         if(this.var_1501 == this.const_1529)
         {
            this.var_73.shift();
         }
         var _loc2_:PlayListEntry = this.getNextEntry();
      ...
      private function requestSongInfo(param1:int) : void
      {
         ...
         if(this.var_531.indexOf(param1) == -1)
         {
            this.var_531.push(param1);
         }
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_531 = this.var_531.splice(this.var_531.indexOf(_loc3_.id),1);
         if(_loc4_)
         {
            _loc7_ = this.var_366[_loc3_.id] as IHabboSound;
            if(_loc7_ == null)
            {
               _loc7_ = this.var_516.loadTraxSong(_loc3_.id,_loc3_.data);
