package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private function createView() : void
      {
         ...
         this.var_420 = new UserInfoCtrl(this._window,this.var_59,_loc3_.message);
         this.var_946 = new UserInfoCtrl(this._window,this.var_59,_loc3_.message);
         this.var_420.load(IWindowContainer(this._window.findChildByName("caller_user_info")),this.var_116.getHighestPriorityIssue().reporterUserId);
         ...
         {
            this.var_946.load(_loc4_,this.var_116.reportedUserId);
         }
         else
         {
      ...
      {
         if(this.var_59 != null && this.var_59.issueManager != null && this.var_116 != null)
         {
            this.var_59.issueManager.removeHandler(this.var_116.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_59.issueManager.closeBundle(this.var_116.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_59.issueManager.closeBundle(this.var_116.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_59.issueManager.closeBundle(this.var_116.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_59.issueManager.releaseBundle(this.var_116.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_59.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_59,WindowTracker.const_1088,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            this.var_420 = new UserInfoCtrl(this._window,this.var_59,_loc3_.message);
            this.var_420.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
