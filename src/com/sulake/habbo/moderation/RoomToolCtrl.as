package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_981:IDropMenuWindow;
      
      private var var_453:ITextFieldWindow;
      
      private var var_567:Boolean = true;
      
      private var var_841:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_45.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_317));
      ...
      public function populate() : void
      {
         ...
         this.var_981 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_981);
         this.var_981.procedure = this.onSelectTemplate;
         this.var_841 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1271 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1270 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_45.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_45,WindowTracker.const_627,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.determineAction(param1,this.var_841.isSelected);
         this.var_45.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1388,_loc2_,this.var_453.text,"",""));
         if(this.var_1271.isSelected || this.var_1270.isSelected || this.var_841.isSelected)
         {
            this.var_45.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1271.isSelected,this.var_1270.isSelected,this.var_841.isSelected));
         }
         this.dispose();
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_45.initMsg.roomMessageTemplates[this.var_981.selection];
         if(_loc3_ != null)
         {
            this.var_567 = false;
            this.var_453.text = _loc3_;
         }
      }
   }
}
