package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         this.var_1126 = IWindowContainer(this.var_45.getXmlWindow("chatlog_roomheader"));
         this.var_1127 = IWindowContainer(this.var_45.getXmlWindow("chatlog_chatline"));
         ...
         this.var_45.connection.send(this.var_1581);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(this.var_1126.clone());
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(this.var_1127.clone());
