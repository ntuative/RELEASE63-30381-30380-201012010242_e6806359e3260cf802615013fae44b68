package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1814:String = "open_issues";
      
      private const const_1816:String = "picked_issues";
      
      private const const_1832:String = "closed_issues";
      ...
      private var var_1559:IIssueBrowserView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_226 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_226.numTabItems)
            {
               _loc5_ = this.var_226.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_59,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_226 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_226 == null || this.var_226.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_226.selector.getSelectableByName("open_issues");
         this.var_226.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_310.view.width = this.var_226.container.width;
         this.var_310.view.height = this.var_226.container.height;
         this.var_310.visible = true;
         this.var_310.update();
      }
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1815:
               ...
               {
                  this.var_1557 = new MyIssuesView(this.issueManager,this,this.var_226.container);
               }
               return this.var_1557;
            case this.const_1814:
               if(this.var_1559 == null)
               {
                  this.var_1559 = new OpenIssuesView(this.issueManager,this,this.var_226.container);
               }
               return this.var_1559;
            case this.const_1816:
               if(this.var_1558 == null)
               {
                  this.var_1558 = new PickedIssuesView(this.issueManager,this,this.var_226.container);
               }
