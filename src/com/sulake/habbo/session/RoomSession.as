package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_1813:int = 2500;
      ...
      public function RoomSession(param1:int, param2:int, param3:IHabboTracking, param4:String = "", param5:String = "")
      {
         ...
         this.var_998 = new UserDataManager();
      }
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         {
            this.var_998.connection = param1;
         }
      }
      ...
      {
         if(this._state == RoomSessionEvent.const_235 && this._connection != null)
         {
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1234));
         this.var_1235.add(this.var_1234,getTimer());
         ++this.var_1234;
      }
      
      public function receivedChatWithTrackingId(param1:int) : void
      {
         var _loc2_:Object = this.var_1235.remove(param1);
         if(_loc2_ != null)
         {
            if(getTimer() - int(_loc2_) > this.const_1813)
            {
      ...
      {
         return this.var_998 as IUserDataManager;
      }
