package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_694)
         {
            this.var_694 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_694)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_695)
         {
            this.var_695 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_695)
            {
               return;
            }
