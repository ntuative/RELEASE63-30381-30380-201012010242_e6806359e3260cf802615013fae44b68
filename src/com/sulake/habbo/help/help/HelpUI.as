package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      {
         this.var_298 = this._defaultViewId;
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201012010237));
         this._toolbar = param5;
         this.var_92 = new Map();
         this.var_92.add(HabboHelpViewEnum.const_1414,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_160,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_537,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_304,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_217,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_628,IHelpViewController(new FaqBrowseSearchResults(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_322,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_749,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_239,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_92.add(HabboHelpViewEnum.const_889,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_92.add(HabboHelpViewEnum.const_1002,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_593,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_425.length == 0 || param1 != this.var_298)
            {
               this.var_425.push(this.var_298);
            }
         }
         this.var_298 = param1;
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + this.var_298);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_239:
               ...
               break;
            case CallForHelpResultEnum.const_1018:
               this.showUI(HabboHelpViewEnum.const_1002);
               break;
            case CallForHelpResultEnum.const_937:
               this.showUI(HabboHelpViewEnum.const_889);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_92.getValue(HabboHelpViewEnum.const_160) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_467));
      }
      ...
      {
         return this.var_92.getValue(this.var_298);
      }
      ...
      private function createWindow() : void
      {
         ...
         this._window.setParamFlag(WindowParam.const_27);
         ...
         if(_loc3_ != null)
         {
            _loc3_.setParamFlag(WindowParam.const_27);
         ...
         this.var_1464 = this._window.width - _loc4_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_1465;
         this._window.width = _loc1_.width + this.var_1464;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_425.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_298 == HabboHelpViewEnum.const_160)
         {
            return;
         }
         if(this.var_525.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_525.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_525.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_299.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_525[1],this.var_525[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_525[0],this.var_525[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_298 == HabboHelpViewEnum.const_160 || this.var_425.length == 0)
         {
            return;
         }
         if(this.var_299 == null)
         {
            ...
            this.var_299 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
            _loc4_ = this.var_299.findChildByName("back_image");
            if(_loc4_ != null)
            {
               _loc4_.setParamFlag(WindowParam.const_27);
            ...
            _loc5_ = this.var_299.findChildByName("back_text");
            if(_loc5_ != null)
            {
               _loc5_.setParamFlag(WindowParam.const_27);
               _loc5_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onBack);
            }
         }
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_299 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_299 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_299 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
