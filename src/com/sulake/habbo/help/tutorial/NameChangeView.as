package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1308:uint = 13232628;
      
      private static var var_1663:uint = 11129827;
      ...
      private var var_1069:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1664 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_694)
         {
            this.var_694 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_694)
            {
               return;
            }
            this._window.content.addChild(this.var_694);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_695)
         {
            this.var_695 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_695)
            {
               return;
            }
            this._window.content.addChild(this.var_695);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_695.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_473;
         }
         this.showView(this.var_695);
      }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         _loc5_.visible = true;
         this.var_1069 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1069.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1308;
