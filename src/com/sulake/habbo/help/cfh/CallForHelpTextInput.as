package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTextInput extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1220:int = 30;
      
      private static const const_1175:int = 253;
      
      private static const const_1176:int = 10;
      ...
      override public function render() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.setParamFlag(WindowParam.const_27);
         ...
         if(_loc2_ != null)
         {
            _loc2_.setParamFlag(WindowParam.const_27);
      ...
      {
         main.showUI(HabboHelpViewEnum.const_160);
      }
      ...
      private function sendCallForHelp() : void
      {
         ...
         if(inputField.text.length < const_1220)
         {
