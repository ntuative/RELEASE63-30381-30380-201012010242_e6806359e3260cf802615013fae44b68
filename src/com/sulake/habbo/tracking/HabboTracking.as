package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_877:uint = 11;
      ...
      private var var_603:FramerateTracker = null;
      
      private var var_249:LatencyTracker = null;
      
      private var var_601:LagWarningLogger = null;
      
      private var var_602:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_603 = new FramerateTracker();
         this.var_249 = new LatencyTracker();
         this.var_601 = new LagWarningLogger();
         this.var_602 = new ToolbarClickTracker(this);
         this.var_1369 = new Array(const_877);
         var _loc4_:int = 0;
         while(_loc4_ < const_877)
         {
            this.var_1369[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1326,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1311,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_774,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_920,String(0));
         }
         ...
         if(!disposed)
         {
            ...
            if(this.var_185)
            {
               if(!this.var_185.disposed)
               {
                  ...
                  Component(this.var_185).events.removeEventListener(HabboFriendListTrackingEvent.const_321,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_168)
            {
               if(!this.var_168.disposed)
               {
                  this.var_168.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_168.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_168.release(new IIDHabboHelp());
               this.var_168 = null;
            }
            if(this._toolbar)
            {
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_169)
         {
            if(this.var_249 != null)
            {
               this.var_249.configuration = this.var_169;
            }
            if(this.var_248 != null)
            {
               this.var_248.configuration = this.var_169;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1270);
            if(this.var_169)
            {
               if(this.var_601 != null)
               {
                  this.var_601.configure(this.var_169);
               }
               if(this.var_603 != null)
               {
                  this.var_603.configure(this.var_169);
               }
               if(this.var_602 != null)
               {
                  this.var_602.configure(this.var_169);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_577,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_65,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_524,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_601 != null)
            {
               this.var_601.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_577)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1286);
         }
         else if(param1.type == HabboHotelViewEvent.const_524)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1293);
         }
         else if(param1.type == HabboHotelViewEvent.const_65)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1353);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboCommunicationEvent.const_769:
               this.trackLoginStep(HabboLoginTrackingStep.const_1452,String(this._communication.port));
               break;
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_169)
            {
               if(this.var_169.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1369)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1010);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1010,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_185).events.addEventListener(HabboFriendListTrackingEvent.const_321,this.onFriendlistTrackingEvent);
      }
      ...
      {
         this.var_168 = param2 as IHabboHelp;
         this.var_168.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_168.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_920,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_774,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_297,this.onRoomAdClick);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_260 = param2 as IAdManager;
         this.var_260.events.addEventListener(AdEvent.const_515,this.onRoomAdLoad);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_602)
         {
            this.var_602.track(param1.iconName);
         }
      }
      ...
      {
         this.var_601.chatLagDetected();
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_1124 > -1 && _loc2_ < this.var_1124)
         {
            ++this.var_1784;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1784);
         }
         if(this.var_1124 > -1 && _loc2_ - this.var_1124 > 15000)
         {
            ++this.var_1785;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1785);
         }
         this.var_1124 = _loc2_;
         if(this.var_248 != null)
         {
            this.var_248.update(param1);
         }
         if(this.var_249 != null)
         {
            this.var_249.update(param1);
         }
         if(this.var_603 != null)
         {
            this.var_603.trackUpdate(param1,this);
         }
         if(this.var_601 != null)
         {
            this.var_601.update();
