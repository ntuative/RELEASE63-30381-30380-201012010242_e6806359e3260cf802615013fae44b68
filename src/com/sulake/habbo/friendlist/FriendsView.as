package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      private var var_2499:IContainerButtonWindow;
      
      private var var_2496:IContainerButtonWindow;
      
      private var var_2497:IContainerButtonWindow;
      
      private var var_2498:IContainerButtonWindow;
      ...
      {
         this.var_2499 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2496 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2497 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2498 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2499,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2496,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2497,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2498,this.isEnableRemoveButton(_loc1_));
      }
