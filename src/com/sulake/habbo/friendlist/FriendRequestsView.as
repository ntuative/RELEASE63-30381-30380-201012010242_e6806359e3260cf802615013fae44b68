package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1558:String = "no_reqs_info";
      ...
      private var var_1774:IContainerButtonWindow;
      
      private var var_1775:IContainerButtonWindow;
      ...
      {
         this.var_1774 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1775 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1775.procedure = this.onDismissAllButtonClick;
         this.var_1774.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_341)
         {
            this._friendList.refreshText(_loc2_,"info_text",true,"${friendlist.request.declined}");
         }
         else if(param1.state == FriendRequest.const_900)
         {
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_341;
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_367 && _loc4_.state != FriendRequest.const_341)
            {
               _loc4_.state = FriendRequest.const_341;
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1774,_loc1_);
         this.setEnabled(this.var_1775,_loc1_);
      }
