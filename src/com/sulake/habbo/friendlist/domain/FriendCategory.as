package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_358:int = 100;
      ...
      {
         if(this.var_878 >= this.getPageCount())
         {
            this.var_878 = Math.max(0,this.getPageCount() - 1);
         }
      }
      
      public function getPageCount() : int
      {
         return Math.ceil(this.var_207.length / const_358);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_878 * const_358;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_878 + 1) * const_358,this.var_207.length);
      }
