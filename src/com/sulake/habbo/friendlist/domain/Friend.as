package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1662:int = "F".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_1517 = param1.lastAccess;
         this.var_1192 = param1.categoryId;
         this.var_1520 = param1.realName;
