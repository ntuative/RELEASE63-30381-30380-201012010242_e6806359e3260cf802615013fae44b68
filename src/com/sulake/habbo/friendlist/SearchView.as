package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      public function fillFooter(param1:IWindowContainer) : void
      {
         ...
         this.var_731.addEventListener(WindowKeyboardEvent.const_153,this.onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            this.var_51.getListItemAt(_loc1_).color = this._friendList.laf.getRowShadingColor(FriendListTab.const_372,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
