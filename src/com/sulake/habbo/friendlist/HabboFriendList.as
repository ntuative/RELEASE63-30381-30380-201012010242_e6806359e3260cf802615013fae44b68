package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_941:IAvatarRenderManager;
      
      private var var_664:ISessionDataManager;
      
      private var var_2139:FriendListLookAndFeel;
      
      private var var_399:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1532:OpenedToWebPopup;
      
      private var var_2138:int;
      
      var var_91:FriendCategories;
      
      private var var_308:FriendRequests;
      
      private var var_1531:AvatarSearchResults;
      ...
      {
         this.var_2139 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_91 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1531 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_539.stop();
            this.var_539.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_539 = null;
         }
         ...
         if(this.var_941)
         {
            this.var_941.release(new IIDAvatarRenderManager());
            this.var_941 = null;
         }
         if(this.var_893)
         {
         ...
         if(this.var_664)
         {
            this.var_664.release(new IIDSessionDataManager());
            this.var_664 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1532 = new OpenedToWebPopup(this);
         }
         this.var_1532.show(x,y);
      }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_308.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_303,HabboWindowStyle.const_38,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_941.createAvatarImage(param1,AvatarScaleType.const_82,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_941 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_664 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_308 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_91.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_91.addCategory(new FriendCategory(FriendCategory.const_952,this.getText("friendlist.friends")));
         this.var_91.addCategory(new FriendCategory(FriendCategory.const_346,this.getText("friendlist.friends.offlinecaption")));
         ...
         if(!this.var_539)
         {
            this.var_539 = new Timer(120000);
            this.var_539.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_539.start();
         }
         ...
         {
            _loc5_ = this.var_91.findCategory(FriendCategory.const_346);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_308.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_308.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_399.findTab(FriendListTab.const_92).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_308.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_399.findTab(FriendListTab.const_92);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1531.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_399.findTab(FriendListTab.const_92);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_664 || !this.var_308)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_664.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = this.var_308.vipLimit;
         }
         else if(this.var_664.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = this.var_308.clubLimit;
         }
         if(_loc2_ > this.var_308.limit)
         {
            this.var_308.limit = _loc2_;
         }
      }
