package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1795:int = 5;
      ...
      private var var_938:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_937 = 0;
         this.var_938 = param2.rectangle.clone();
         this.var_938.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_938.width)
         {
            return false;
         }
         if(this.var_937 + param1.height > this.var_938.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_938.width)
         {
            this._offsetX = 0;
            this.var_937 += param1.height + this.const_1795;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_937);
         this._offsetX += param1.width + this.const_1794;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1177 != null && this.var_1177.indexOf(param1) != -1)
         {
