package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1804:int = 158;
      
      private const const_1802:int = 16;
      
      private const const_1803:uint = 11184810;
      
      private const const_1798:uint = 6710886;
      
      private const const_1800:uint = 3355443;
      
      private const const_1797:String = "level";
      
      private const const_1801:String = "experience";
      
      private const const_1799:String = "energy";
      
      private const const_1805:String = "nutrition";
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1797,param1.level,param1.levelMax);
         this.updateStateElement(this.const_1801,param1.experience,param1.experienceMax);
         this.updateStateElement(this.const_1799,param1.energy,param1.energyMax);
         this.updateStateElement(this.const_1805,param1.nutrition,param1.nutritionMax);
         ...
         this.updateWindow();
         this.var_547 = param1.id;
         this.var_1197.remove(param1.id);
         this.var_1197.add(param1.id,param1);
         if(this.var_176 && this.var_176.isVisible() && param1.isOwnPet)
         {
            this.var_176.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         this.var_176.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(this.const_1804,this.const_1802,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),this.const_1803);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,this.const_1800);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,this.const_1798);
         return _loc5_;
      }
      ...
      private function openTrainView() : void
      {
         if(this.var_176 == null)
         {
            this.var_176 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this.var_1197.getValue(this.var_547) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_176.showWindow(true);
            this.var_176.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc6_:IBitmapWrapperWindow = this.var_199.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_176 && this.var_176.getPetId() == this.var_547)
               {
                  this.var_176.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
