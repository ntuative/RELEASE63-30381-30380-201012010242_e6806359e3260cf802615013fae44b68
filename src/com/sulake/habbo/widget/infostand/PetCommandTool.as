package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private const const_1817:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_375 = new Timer(this.const_1817);
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:Array = this.var_1002.getValue(param1) as Array;
         if(_loc6_ == null)
         {
            this.updateCommandButtonsViewState(new Array());
            this.requestEnabledCommands(this.var_547);
         }
         else
         {
      ...
      {
         var _loc2_:Array = this.var_1002.getValue(this.var_547) as Array;
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_633,param1);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_41.context.getDesktopWindow().addEventListener(WindowEvent.const_46,this.onWindowDesktopResized);
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_374 == null)
         {
            ...
            this.var_374 = (this._widget.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_374 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_374.x = 200;
            this.var_374.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_349,this.var_547));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_625,this.var_547,this.var_2197 + " " + _loc6_);
