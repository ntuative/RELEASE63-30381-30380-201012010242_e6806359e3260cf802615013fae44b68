package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++this.var_984;
         if(this.var_984 < this.var_806.length)
         {
            _loc1_ = this.var_806[this.var_984] as Dictionary;
            if(!_loc1_)
            {
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!this.var_370)
         {
            ...
            this.var_370 = this._widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            this.var_370.center();
            this.var_370.procedure = this.cancelConfirmEventProc;
         }
      }
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = this.var_806[this.var_984] as Dictionary;
