package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_55,HabboWindowStyle.const_35,0 | 0,new Rectangle(const_1154,const_1155,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            this.var_364 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
         this.var_226 = ITabContextWindow(this._window.findChildByName("tab_context"));
         this.selectTab(this._widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < this.var_226.numTabItems)
         {
            _loc6_ = this.var_226.getTabItemAt(_loc2_);
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1211 = _loc2_.light;
         if(this.var_364 != null)
         {
            this.var_364.setValue(this.var_1211);
         }
         this.var_492 = this.colors.indexOf(_loc2_.color);
         if(this.var_529 != null)
         {
            this.var_529.setSelectedColorIndex(this.var_492);
         }
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = this.var_226.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            this.var_226.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = this.var_226.selector.getSelected();
         return this.var_226.selector.getSelectableIndex(_loc1_);
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_364 != null)
         {
            this.var_364.min = this._widget.minLights[param1 - 1];
         }
      }
