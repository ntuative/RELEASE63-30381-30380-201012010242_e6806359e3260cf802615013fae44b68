package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_843:int = 16;
      
      private static const const_1182:int = 40;
      ...
      private var var_496:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_1006 = this._localization.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2201 = this._localization.getKey("widgets.chatinput.mode.shout",":shout");
         this._chatModeIdSpeak = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_820 = new Timer(1000,1);
         this.var_820.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_1005 = new Timer(5000,1);
         this.var_1005.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
         this.refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_55,HabboWindowStyle.const_38,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         this.var_2200 = _loc2_.width + const_843 + _loc6_.width + const_1181;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1182,_loc8_.width) + const_843);
            _loc8_.x = _loc12_;
      ...
      {
         this.var_496 = param1 - this.var_2200;
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),this.var_496);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,this.var_496);
         }
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == this.var_1006 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  this.var_454 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(!this._widget.allowPaste && _loc2_.text.length > this.var_454.length + 1)
            {
               _loc2_.text = "";
            }
            this.var_454 = _loc2_.text;
            if(!this.var_821)
            {
               this.var_821 = true;
               this.var_820.reset();
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_821);
      ...
      private function checkInputFieldLimits() : void
      {
         ...
         if(_loc1_.textWidth >= this.var_496)
         {
