package com.sulake.habbo.widget.chooser
{
   ...
   public class FurniChooserWidget extends ChooserWidgetBase
   {
      ...
      private var var_597:ChooserView;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_566,this.onUpdateFurniChooser);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_566,this.onUpdateFurniChooser);
      }
      ...
      private function onChooserContent(param1:RoomWidgetChooserContentEvent) : void
      {
         ...
         if(this.var_597 == null)
         {
            this.var_597 = new ChooserView(this,"${widget.chooser.furni.title}");
         }
         this.var_597.populate(param1.items,param1.isAnyRoomController);
      }
