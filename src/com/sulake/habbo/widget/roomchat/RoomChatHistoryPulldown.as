package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_830:int = 150;
      
      private static const const_829:int = 250;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_35 = param3;
         this.var_2058 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1492 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2057 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1490 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1491 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2056 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2054 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_67 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_303,HabboWindowStyle.const_35,HabboWindowParam.const_61,new Rectangle(0,0,param3.width,param3.height - const_78),null,0,0) as IBitmapWrapperWindow;
         this.var_35.addChild(this.var_67);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_55,HabboWindowStyle.const_35,0 | 0,new Rectangle(0,this.var_35.height - const_78,param3.width,const_78),null,0) as IWindowContainer;
         this.var_35.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_561,HabboWindowStyle.const_38,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_78),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_427:
               this.var_67.blend += param1 / const_829;
               this._window.blend += param1 / const_829;
               ...
               break;
            case const_831:
               this.var_67.blend -= param1 / const_830;
               this._window.blend -= param1 / const_830;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(this._region != null)
         {
            ...
            this._region.width = this.var_35.width - this.var_2055;
         }
         if(this.var_67 != null)
         {
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2059 == this._window.width)
         {
            return;
         }
         this.var_2059 = this._window.width;
         ...
         {
            _loc5_.bitmap = this.var_2057;
            _loc5_.disposesBitmap = false;
            _loc2_.bitmap = this.var_1490;
            _loc2_.disposesBitmap = false;
            this.var_2055 = this._window.width - _loc2_.x;
         }
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_2058,_loc7_);
            ...
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1492,_loc8_);
            ...
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1492,_loc9_);
         ...
         this.var_67.bitmap = this.var_2054;
