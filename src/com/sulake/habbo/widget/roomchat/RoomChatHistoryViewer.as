package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1190:int = 18;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_157.state = RoomChatHistoryPulldown.const_207;
         ...
         this.var_43 = param2.createWindow("chatscroller","",HabboWindowType.const_893,HabboWindowStyle.const_38,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_157.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_207);
      }
      ...
      {
         return !!this.var_377 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_157.state == RoomChatHistoryPulldown.const_333 || this.var_157.state == RoomChatHistoryPulldown.const_427;
      }
      ...
      {
         if(!this.var_377 && !this.var_1467)
         {
            this.var_377 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_157.state = RoomChatHistoryPulldown.const_333;
            if(this._widget != null)
            {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_378 > 0 && param2)
         {
            if(this.var_1575)
            {
               if(Math.abs(param1 - this.var_378) <= const_958)
               {
                  return;
               }
               this.var_1575 = false;
            ...
            if(this.var_377)
            {
               ...
               _loc5_ = (param1 - this.var_378) / this.var_43.height;
               ...
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_43.scrollV < 1 - const_1190 / this.var_43.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_1576)
               {
