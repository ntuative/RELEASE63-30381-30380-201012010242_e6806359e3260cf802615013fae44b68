package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      {
         this.var_490 = param1.volume;
         if(this.var_875 != null)
         {
            this.var_875.setValue(this.var_490);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_705));
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_490 == 0)
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1735);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1737);
         }
      }
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_490 == 1)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1736);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1738);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_727);
         }
