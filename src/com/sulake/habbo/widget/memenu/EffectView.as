package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      {
         super();
         this.var_178 = new Timer(1000);
         this.var_178.addEventListener(TimerEvent.TIMER,this.onUpdate);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_178.stop();
            this.var_178.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_178 = null;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            if(this.var_167.isActive)
            {
               _loc2_ = this.var_167.secondsLeft / Number(this.var_167.duration);
               this.var_865.width = _loc2_ * this.var_496;
            }
            else
            {
               this.var_865.width = 0;
               this.var_178.stop();
            }
            this.setTimeLeft();
         }
      ...
      private function setTimeLeft() : void
      {
         ...
         if(this.var_864 != null)
         {
            ...
            if(this.var_167.isActive)
            {
               _loc2_ = this.var_167.secondsLeft;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc7_:* = null;
         var _loc3_:String = "";
         if(this.var_167.isInUse)
         {
            _loc3_ = "memenu_effect_selected";
         }
         else if(this.var_167.isActive)
         {
         ...
         this.setTimeLeft();
         this.var_865 = this._window.findChildByName("loader_bar");
         if(this.var_865 != null)
         {
            this.var_496 = this.var_865.width;
            this.var_178.start();
            this.onUpdate();
         }
         if(this.var_167.icon)
         {
            this.setElementBitmap("effect_icon",this.var_167.icon);
         }
      }
