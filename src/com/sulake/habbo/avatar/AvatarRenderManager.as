package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_1828:String = "hd-99999-99999";
      ...
      private var var_711:PaletteManager;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_564 = RenderMode.const_1425;
         ...
         this.var_96.add(AvatarType.const_115,_loc4_);
         ...
         this.var_96.add(AvatarType.const_64,_loc4_);
         ...
         this.var_711 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_332.init();
         this.var_711.init();
         _loc2_ = this.var_96.getValue(AvatarType.const_115) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_96.getValue(AvatarType.const_64) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_96.getValue(AvatarType.const_115) as AvatarStructure;
            if(_loc3_ != null)
            {
               ...
               if(this.var_204 == null)
               {
                  ...
                  this.var_204 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
      ...
      private function checkIfReady() : void
      {
         if(!this.var_909)
         {
            if(this.var_2428 && this.var_2426 && this.var_2427)
            {
      ...
      {
         var _loc5_:AvatarStructure = this.var_96.getValue(AvatarType.const_115) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1726)
         {
            this.var_1726 = new AvatarFigureContainer(this.const_1828);
         }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:int = 0;
         if(param1 == null || this.var_273 == null)
         {
            return;
         }
         var _loc2_:Array = new Array();
         for each(_loc3_ in this.var_273.getKeys())
         {
            _loc4_ = this.var_273.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1500)
         {
            _loc6_ = !this.var_332.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_332.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_96.getValue(AvatarType.const_64) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(param5 != null)
         {
            ...
            this.var_273.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_96.getValue(AvatarType.const_64);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_273.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_273.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc3_:AvatarStructure = this.var_96.getValue(AvatarType.const_115) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_64:
               _loc3_ = this.var_96.getValue(AvatarType.const_64) as AvatarStructure;
               break;
            default:
