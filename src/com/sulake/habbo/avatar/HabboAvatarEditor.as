package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1165:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      ...
      private var var_985:AvatarEditorHandler;
      ...
      private var var_807:IFigureData;
      ...
      private function init() : void
      {
         ...
         if(!this.var_174)
         {
            ...
            this.var_540["null"] = new FigureData(this);
            _loc1_ = this.var_540["null"];
            _loc2_ = this.var_540["null"];
            _loc1_.loadAvatarData(const_1165,FigureData.const_72);
            _loc2_.loadAvatarData(const_1164,FigureData.FEMALE);
            this.var_91 = new Map();
            this.var_446 = new Map();
            this.var_91.add(AvatarEditorFigureCategory.const_801,new BodyModel(this));
            ...
            this.var_91.add(AvatarEditorFigureCategory.const_626,new LegsModel(this));
            this.var_91.add(AvatarEditorFigureCategory.const_1031,new HotLooksModel(this));
            this.var_446.add(AvatarEditorSideCategory.const_96,new WardrobeModel(this));
            this.var_446.add(AvatarEditorSideCategory.const_434,new ClubPromoModel(this));
            this.var_174 = true;
         }
      }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_807.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_807.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_225 == null)
            {
               this.var_225 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_55,HabboWindowStyle.const_35,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_225.addChild(this._view.window);
               if(param5)
               {
                  this.var_225.center();
               }
            ...
            this.var_225.visible = !this.var_225.visible;
         }
         this._view.show();
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_445 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_807 = this.var_445.getFigureData(AvatarType.const_115);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_985 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_540[this.var_883];
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1534;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_986 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1166)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1399.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_445.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_445.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1146.clone() as IWindowContainer,param1,null,null,false);
            ...
            for each(_loc6_ in _loc8_.partSets)
            {
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_986 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1146.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_986 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_446.getValue(AvatarEditorSideCategory.const_96);
      }
