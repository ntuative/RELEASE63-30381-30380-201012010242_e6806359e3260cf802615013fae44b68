package com.sulake.habbo.avatar
{
   ...
   public class PlaceholderPetImage extends PetImage
   {
      ...
      public function PlaceholderPetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String, param5:IAssetLibrary)
      {
         ...
         var _loc6_:AvatarCanvas = _structure.getCanvas(_scale,var_252.definition.geometryType);
         if(_loc6_)
         {
      ...
      private function getPlaceHolderImage(param1:int, param2:String) : BitmapData
      {
         ...
         _loc3_ += "_png";
         _loc6_;
         var _loc4_:BitmapData = this.var_553.getValue(_loc3_);
         if(!_loc4_)
         {
            ...
            _loc6_;
            this.var_553.add(_loc3_,_loc4_.clone());
            _loc4_ = this.var_553.getValue(_loc3_);
         }
         return _loc4_;
      }
