   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_34)
         {
            ...
            var_34["null"] = new AvatarEditorGridView(var_63,FigureData.const_230,_windowManager,_assetLibrary);
            var_34["null"] = new AvatarEditorGridView(var_63,FigureData.const_231,_windowManager,_assetLibrary);
         }
         else
         {
