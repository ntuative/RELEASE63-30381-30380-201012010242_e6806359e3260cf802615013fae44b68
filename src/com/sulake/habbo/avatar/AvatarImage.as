package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      protected var var_230:AvatarImageCache;
      
      protected var var_598:AvatarFigureContainer;
      
      protected var var_503:IAvatarDataContainer;
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_258.length == 1 && this.var_84 == this.var_1856)
         {
            return this.var_84 + this.var_421 + this.var_522 % 4;
         }
         if(this.var_258.length == 2)
         {
            for each(_loc1_ in this.var_258)
            {
               ...
               {
                  return this.var_84 + this.var_421 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_522 % 11;
                  return this.var_84 + "_" + this.var_1856 + this.var_421 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_1977 || param2 != this.var_1978 || param1 != this.var_1976)
         {
            this.var_1977 = param3;
            this.var_1978 = param2;
            this.var_1976 = param1;
            this.var_1451 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_252.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1149 || this.var_38 == null || (this.var_38.width != _loc5_.width || this.var_38.height != _loc5_.height))
         {
            if(this.var_38 != null && !this.var_1149)
            {
               this.var_38.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_252.definition.geometryType,this.var_84);
         this.var_38.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_522);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_522);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_288.push(new ActiveActionData(param1,param2,this.var_522));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.resetBodyPartCache(this.var_859);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_421 = "";
         this.var_258 = this._structure.sortActions(this.var_288);
         if(this.var_258 == null)
         {
         ...
         {
            this.var_660 = this._structure.getCanvasOffsets(this.var_258,this._scale,this.var_84);
            for each(_loc4_ in this.var_258)
            {
               this.var_421 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_308)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1186 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1186 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_258)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_283 || _loc1_.actionType == AvatarAction.const_220 || _loc1_.actionType == AvatarAction.const_353)
               {
                  this.var_824 = true;
               }
            }
