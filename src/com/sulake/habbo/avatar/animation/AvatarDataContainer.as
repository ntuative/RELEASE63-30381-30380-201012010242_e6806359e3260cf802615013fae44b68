package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1425:Number = 1.0;
      
      private var var_1429:Number = 1.0;
      ...
      {
         super();
         this.var_1419 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_1912 = parseInt(_loc2_,16);
         this.var_1914 = parseInt(_loc3_,16);
         ...
         this.var_1811 = new ColorTransform(this.var_1427,this.var_1425,this.var_1429,this._alphaMultiplier);
         this.var_933 = this.generatePaletteMapForGrayscale(this.var_1914,this.var_1912);
      }
      ...
      {
         return this.var_933.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_933.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_933.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_933.getValue("alphas") as Array;
      }
