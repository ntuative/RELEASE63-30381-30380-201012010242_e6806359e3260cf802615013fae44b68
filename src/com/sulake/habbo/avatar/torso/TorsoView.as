   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_34)
         {
            ...
            var_34["null"] = new AvatarEditorGridView(var_63,FigureData.const_237,_windowManager,_assetLibrary);
            var_34["null"] = new AvatarEditorGridView(var_63,FigureData.const_164,_windowManager,_assetLibrary);
         ...
         if(var_63 && var_132 == "")
         {
            var_63.switchCategory(FigureData.const_164);
         }
      }
