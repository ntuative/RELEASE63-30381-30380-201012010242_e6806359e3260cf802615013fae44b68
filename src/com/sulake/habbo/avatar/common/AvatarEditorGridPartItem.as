package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem implements IAvatarImageListener
   {
      ...
      private const const_1812:int = 13421772;
      
      private const const_1811:int = 16777215;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         this.var_401 = this.var_63.controller.avatarRenderManager;
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(_loc1_)
         {
            if(this.var_620 != null && !this.var_1807)
            {
               _loc3_ = this.var_620;
            }
            else
            ...
            if(this.var_732)
            {
               switch(this.var_732.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_58:
                     _loc2_.style = HabboIconType.const_795;
                     break;
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         var _loc1_:AvatarFigureContainer = this.var_401.createFigureContainer(this.partSet.type + "-" + this.partSet.id);
      ...
      private function renderThumb() : BitmapData
      {
         ...
         if(this.var_610 == null)
         {
            if(!this.analyzePartLayers())
            {
               if(!this.var_1808)
               {
                  ...
                  this.var_1808 = _loc9_.content as BitmapData;
               }
         ...
         for each(_loc2_ in _loc8_)
         {
            ...
            if(_loc4_)
            {
               ...
               if(this.var_1807 && _loc2_.colorLayerIndex > 0)
               {
