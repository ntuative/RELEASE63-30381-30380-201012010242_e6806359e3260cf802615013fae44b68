package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_837:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_718.width,this.var_718.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_718,this.var_718.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_1020.width,this.var_1020.height,true,0);
            _loc5_ = this.var_1020.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_837.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_836.width,this.var_836.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_836,this.var_836.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
