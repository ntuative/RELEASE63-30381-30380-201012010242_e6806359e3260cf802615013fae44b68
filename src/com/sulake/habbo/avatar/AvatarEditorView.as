package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1146:IWindowContainer;
      
      public static var var_1399:IWindowContainer;
      
      public static var var_1835:int = 6710886;
      ...
      private var var_472:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1067 = [];
         this.var_1307 = [AvatarEditorFigureCategory.const_801,AvatarEditorFigureCategory.const_43,AvatarEditorFigureCategory.const_247,AvatarEditorFigureCategory.const_626,AvatarEditorFigureCategory.const_1031,AvatarEditorFigureCategory.const_96];
         super();
         ...
         if(var_1146 == null)
         {
            ...
            var_1146 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1399 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1399 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_388 = new Timer(1000);
         this.var_388.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1307;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1307);
         }
         if(param1.length != this.var_1067.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1067.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2355 = this.canChangeOutfit();
            this.var_388.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_472 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_472.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_472.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1067.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_472.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_472.numSelectables)
               {
                  this.var_472.getSelectableAt(_loc6_).x = this.var_472.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1307;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe") && (this.var_1660 == AvatarEditorSideCategory.const_96 || this.var_2354))
         {
         ...
         this.setViewToCategory(this.var_298);
      }
      ...
      {
         if(this.var_1660 == AvatarEditorSideCategory.const_96)
         {
            this.var_2354 = false;
            this.setSideContent(AvatarEditorSideCategory.const_660);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_660:
               break;
            case AvatarEditorSideCategory.const_434:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_434);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_298 = param1;
         this.var_472.setSelected(this.var_472.getSelectableByName(param1));
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_471)
         {
            ...
            this.var_471 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_471.procedure = this.stripClubDialogEventProc;
            this.var_471.center();
         }
         else
         {
