package com.sulake.habbo.messenger
{
   ...
   public class ConversationsTabView
   {
      ...
      {
         return Math.floor(this.var_905.width / this.var_1133);
      }
      ...
      private function refreshTabContent(param1:int, param2:Conversation) : Boolean
      {
         ...
         _loc3_.x = param1 * this.var_1133;
         _loc3_.width = this.var_1133;
         return false;
      }
      ...
      private function refreshAsArrow(param1:int, param2:Boolean) : void
      {
         ...
         var _loc4_:int = this.var_905.width % this.var_1133;
         _loc3_.width = this.var_1133 + (!!param2 ? _loc4_ : 0);
      }
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc4_ = param2.name == HabboMessenger.const_152 ? this.var_126.conversations.findConversation(param2.id) : this.var_126.conversations.openConversations[_loc3_ + this.var_126.conversations.startIndex];
            if(_loc4_ == null)
            {
               return;
            }
