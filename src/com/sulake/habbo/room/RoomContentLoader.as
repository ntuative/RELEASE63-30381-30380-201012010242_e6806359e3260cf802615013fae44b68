package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      private static const const_1167:String = const_384;
      
      private static const ROOM_CONTENT:String = "room";
      
      private static const const_837:String = "tile_cursor";
      
      private static const const_835:String = "selection_arrow";
      ...
      private var var_1229:IEventDispatcher = null;
      ...
      public function RoomContentLoader()
      {
         this.var_545 = [];
         this._wallItems = [];
         this.var_2151 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         this.var_2150 = ["room_public","room_public_park","room_public_pool"];
         super();
      ...
      {
         if(this._state >= const_836)
         {
            return;
         }
         this.var_1229 = param1;
         this.var_2149 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2146 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2147 = param2.getKey("public.room.dynamic.download.url","");
         this.var_2148 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         this._state = const_836;
         this.initFurniData();
      }
      ...
      private function initFurniData() : void
      {
         ...
         var _loc1_:Array = this.var_354.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_371.length;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc4_ = this.var_371.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               this.var_665.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_543.add(_loc3_,_loc4_);
               if(this.var_545.indexOf(_loc7_) < 0)
               {
                  this.var_545.push(_loc7_);
               }
            }
            ...
            _loc8_ = this.var_544.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_544.remove(_loc7_);
               this.var_544.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2145)
         {
            ...
            {
               this.var_1229.dispatchEvent(new Event(const_699));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_450 != null)
         {
            this.var_450.remove(param1);
            this.var_450.add(param1,param2);
         }
         if(this.var_449 != null)
         {
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(this.var_450 != null)
         {
            _loc2_ = this.var_450.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(this.var_545.indexOf(param1) >= 0)
         {
      ...
      {
         return [const_384,const_540,ROOM_CONTENT,const_837,const_835];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_543.getValue(param1) as String;
         return this.getObjectType(_loc2_);
      }
      
      public function getWallItemType(param1:int, param2:String = null) : String
      {
         var _loc3_:String = this.var_542.getValue(param1) as String;
      ...
      {
         if(this.var_665.getValue(param1) != null)
         {
      ...
      {
         if(this.var_177 != null && this.var_177.hasWorldType(const_309 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_177 || param1 == RoomObjectVisualizationEnum.const_64 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_28 || _loc2_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_WALLITEM)
         {
            if(param1.indexOf("poster") == 0)
            {
               param1 = "poster";
            }
            return int(this.var_544.getValue(param1));
         }
         return 0;
      }
      ...
      private function getObjectContentURLs(param1:String) : Array
      {
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               {
                  _loc10_ = this.var_2148;
                  _loc10_ = _loc10_.replace(/%typeid%/,_loc7_[_loc9_]);
                  _loc8_.push(this.var_2147 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_28:
                     if(this.var_545.indexOf(_loc4_) == -1)
                     {
                        this.var_545.push(_loc4_);
                     }
                     break;
                  case RoomObjectCategoryEnum.OBJECT_CATEGORY_WALLITEM:
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            this.var_177 = this.var_1230.getValue(param1) as PublicRoomData;
         }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2151.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1272);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_2150.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = this.getVisualizationXML(_loc5_);
               _loc8_ = this.extractPublicRoomFromXML(_loc5_,_loc7_);
               this.var_1230.add(_loc5_,_loc8_);
               this.var_177 = _loc8_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_666.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_666.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = this.var_666.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_205 && _loc5_ != RoomObjectLogicEnum.const_177)
         {
            _loc6_ = "@shadow";
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_474.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
            _loc3_.assetLibrary = param2;
            this.var_371.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:String = this.getContentType(param1);
         return this.var_371.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      private function disposeGraphicAssetCollection(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = this.getContentType(param1);
         if(this.var_371[_loc2_] != null)
         {
            _loc3_ = this.var_371.remove(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      {
         if(this.getObjectCategory(const_309 + param1) == RoomObjectCategoryEnum.const_71)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_177.getWorldHeightScale(const_309 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_177 != null)
         {
            return this.var_177.getWorldScale(const_309 + param1);
         }
         return 32;
      }
