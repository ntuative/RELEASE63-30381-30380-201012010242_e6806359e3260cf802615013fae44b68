package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1290:int = 13421772;
      
      private static const const_824:int = 16777215;
      
      private static const const_827:int = 13421772;
      
      private static const const_826:int = 10066329;
      ...
      public static const const_1476:int = 10066329;
      ...
      private var var_647:Rectangle = null;
      
      private var var_431:RoomPlaneBitmapMaskParser = null;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_431 = new RoomPlaneBitmapMaskParser();
         this.var_262["null"] = false;
         this.var_262["null"] = true;
         this.var_262["null"] = true;
         this.var_262["null"] = true;
      }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_647 = super.boundingRectangle;
         }
         return new Rectangle(this.var_647.x,this.var_647.y,this.var_647.width,this.var_647.height);
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1097);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1045);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_148)
            {
               ...
               {
                  _loc13_.color = const_827;
               }
               else
               {
                  _loc13_.color = const_826;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1433)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_109,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc8_ < this._lastUpdateTime + this.const_1806 && !_loc5_ && !_loc7_)
         {
            return;
         }
         ...
         {
            _loc9_ = 0;
            while(_loc9_ < this.var_303.length)
            {
               _loc10_ = this.var_527[_loc9_];
               _loc11_ = getSprite(_loc10_);
               _loc12_ = this.var_303[_loc9_] as RoomPlane;
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_93)
               {
                  if(this.var_1481)
                  {
                     _loc13_ = uint(_loc12_.color);
                     _loc14_ = uint((_loc13_ & 255) * this.var_2037 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2035 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_2038 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1699)
         {
            this.var_1699 = param1.updateId;
            this.var_647 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1326 || _loc3_.y != this.var_2032 || _loc3_.z != this.var_2033 || param1.scale != this.var_2034))
            {
               this.var_1326 = _loc3_.x;
               this.var_2032 = _loc3_.y;
               this.var_2033 = _loc3_.z;
               this.var_2034 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_915);
            if(_loc3_ != this.var_2031)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2031 = _loc3_;
               _loc2_ = true;
            }
            ...
            {
               this.var_960 = _loc4_;
               this.var_2037 = this.var_960 & 255;
               this.var_2035 = this.var_960 >> 8 & 255;
               this.var_2038 = this.var_960 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_898));
            if(_loc5_ != this.var_1481)
            {
               this.var_1481 = _loc5_;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_216 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_606);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_678);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_580);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_624));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_645));
      ...
      {
         if(param1 != this.var_262["null"] || param2 != this.var_262["null"] || param3 != this.var_262["null"])
         {
            this.var_262["null"] = param1;
            this.var_262["null"] = param2;
            this.var_262["null"] = param3;
            this.var_303 = [];
            this.var_527 = [];
         }
      }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_303;
         if(this.var_303.length == 0)
         {
            _loc6_ = this.var_120;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_303.length > 0;
         var _loc9_:int = 0;
         while(_loc9_ < _loc6_.length)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_262[_loc12_.type]))
                  {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_303.push(_loc12_);
                        this.var_527.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1482;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_431.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_431.maskCount)
         {
            _loc10_ = this.var_431.getMaskType(_loc8_);
            _loc11_ = this.var_431.getMaskLocation(_loc8_);
            _loc12_ = this.var_431.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_120.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_109 || _loc3_.type == RoomPlane.const_93)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_109 || _loc3_.type == RoomPlane.const_93 && _loc12_ == RoomPlaneBitmapMaskData.const_213)
                              {
