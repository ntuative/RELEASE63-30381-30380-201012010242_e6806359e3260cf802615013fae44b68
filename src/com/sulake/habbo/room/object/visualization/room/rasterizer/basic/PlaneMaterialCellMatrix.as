package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_216:int = 3;
      ...
      public static const const_1471:int = const_319;
      ...
      public static const const_285:int = const_105;
      ...
      public function clearCache() : void
      {
         ...
         if(this.var_658 != null)
         {
            this.var_658.assign(new Vector3d());
         }
         this.var_590 = 0;
         var _loc1_:int = 0;
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_29 != null)
            {
               if(this.var_29.width == param2 && this.var_29.height == param3 && Vector3d.isEqual(this.var_658,param4))
               {
                  if(param1 != null)
                  {
                     this.copyCachedBitmapOnCanvas(param1,this.var_590,param6,param7);
                     return param1;
                  }
                  return this.var_29;
               }
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(this.var_1721 == const_105)
         {
            _loc5_ = new Rectangle(0,0,this.var_29.width,this.var_590);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_29.height - this.var_590,this.var_29.width,this.var_590);
         }
