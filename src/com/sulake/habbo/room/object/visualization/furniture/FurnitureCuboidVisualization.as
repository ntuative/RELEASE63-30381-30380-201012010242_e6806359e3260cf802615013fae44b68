package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureCuboidVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected function initializePlanes() : void
      {
         ...
         var _loc4_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_325);
         var _loc5_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_654);
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:int) : void
      {
         ...
         while(_loc5_ < this.var_120.length)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               if(_loc6_)
               {
                  _loc10_.assetName = _loc7_ + "_" + _loc3_.getInstanceId() + "_" + this.var_1482;
               }
