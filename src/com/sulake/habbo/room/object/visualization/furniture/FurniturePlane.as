package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      private var var_706:Vector3d = null;
      
      private var var_705:Vector3d = null;
      ...
      public function FurniturePlane(param1:IVector3d, param2:IVector3d, param3:IVector3d)
      {
         ...
         this.var_271.assign(param2);
         this.var_272 = new Vector3d();
         this.var_272.assign(param3);
         this.var_706 = new Vector3d();
         this.var_706.assign(param2);
         this.var_705 = new Vector3d();
         this.var_705.assign(param3);
      ...
      {
         if(param1 != this.var_2410)
         {
            if(!param1)
            {
               this.var_271.assign(this.var_706);
               this.var_272.assign(this.var_705);
            }
            else
            {
               this.var_271.assign(this.var_706);
               this.var_271.mul(this.var_705.length / this.var_706.length);
               this.var_272.assign(this.var_705);
               this.var_272.mul(this.var_706.length / this.var_705.length);
            }
            this.var_1699 = -1;
            this.var_1326 = this.var_1326 - 1;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = Number(this.var_271.length * param1.scale);
            _loc6_ = Number(this.var_272.length * param1.scale);
            if(_loc5_ < 1)
            {
               _loc5_ = 1;
            }
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || this.var_76 == null && this.var_945 != null || this.var_271 == null || this.var_272 == null || this.var_521 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != this.var_1699)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != this.var_1326 || _loc4_.y != this.var_2032 || _loc4_.z != this.var_2033 || param1.scale != this.var_2034))
            {
               this.var_1326 = _loc4_.x;
               this.var_2032 = _loc4_.y;
               this.var_2033 = _loc4_.z;
               ...
               _loc6_ = param1.getScreenPosition(this.var_945);
               _loc7_ = _loc6_.z;
               _loc8_ = Math.max(this.var_134.z - _loc7_,this.var_104.z - _loc7_,this.var_80.z - _loc7_,this.var_103.z - _loc7_);
               this.var_1973 = _loc8_;
