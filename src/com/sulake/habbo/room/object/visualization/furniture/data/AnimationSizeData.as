package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class AnimationSizeData extends SizeData
   {
      ...
      {
         var _loc2_:AnimationData = this.var_318.getValue(param1) as AnimationData;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc5_:* = null;
         var _loc4_:AnimationData = this.var_318.getValue(param2) as AnimationData;
         if(_loc4_ != null)
         {
      ...
      {
         var _loc7_:* = null;
         var _loc6_:AnimationData = this.var_318.getValue(param2) as AnimationData;
         if(_loc6_ != null)
         {
