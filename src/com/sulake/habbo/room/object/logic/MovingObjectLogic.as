package com.sulake.habbo.room.object.logic
{
   ...
   public class MovingObjectLogic extends ObjectLogicBase
   {
      ...
      public static const const_976:int = 500;
       
      
      private var var_1366:Vector3d;
      
      private var var_2666:Vector3d;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(object != null)
         {
            if(param1.loc != null)
            {
               ...
               this.var_2520 = this._lastUpdateTime;
               this.var_1366 = _loc4_;
            }
         }
      }
      ...
      override public function update(param1:int) : void
      {
         ...
         {
            _loc2_ = param1 - this.var_2520;
            if(_loc2_ > this.var_963)
            {
               _loc2_ = this.var_963;
            }
            _loc3_ = Vector3d.product(this.var_1366,_loc2_ / Number(this.var_963));
