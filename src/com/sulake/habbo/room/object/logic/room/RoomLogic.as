package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1703:int = 255;
      
      private var var_1087:uint = 16777215;
      
      private var var_1702:int = 255;
      
      private var var_1086:int = 0;
      
      private var var_1704:int = 1500;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1097,param1.toString(),true);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1086)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1509;
            if(_loc2_ - this.var_1086 >= this.var_1704)
            {
               _loc3_ = this.var_1087;
               _loc4_ = this.var_1702;
               this.var_1086 = 0;
            }
            else
            {
               ...
               _loc10_ = this.var_1087 >> 16 & 255;
               _loc11_ = this.var_1087 >> 8 & 255;
               _loc12_ = this.var_1087 & 255;
               _loc13_ = (_loc2_ - this.var_1086) / this.var_1704;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1703 + (this.var_1702 - this.var_1703) * _loc13_;
               this._color = _loc3_;
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_803:
               param2.setString(RoomObjectVariableEnum.const_678,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_784:
               param2.setString(RoomObjectVariableEnum.const_606,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_557:
               param2.setString(RoomObjectVariableEnum.const_580,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_395:
               ...
               this.var_431.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_708:
               _loc4_ = this.var_431.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_431.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_915,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1080:
               param2.setNumber(RoomObjectVariableEnum.const_624,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1048:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_898,int(param1.bgOnly));
         this.var_1327 = this._color;
         this.var_1703 = this.var_1509;
         this.var_1087 = _loc3_;
         this.var_1702 = _loc4_;
         this.var_1086 = getTimer();
         this.var_1704 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1318,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1412,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1244,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_148 || _loc13_ == RoomPlaneData.const_291)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
