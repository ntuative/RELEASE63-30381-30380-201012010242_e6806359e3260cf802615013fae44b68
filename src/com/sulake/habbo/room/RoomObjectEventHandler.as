package com.sulake.habbo.room
{
   ...
   public class RoomObjectEventHandler implements IRoomRenderingCanvasMouseListener
   {
      ...
      public function setSelectedObject(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         switch(param4)
         {
            ...
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_WALLITEM:
               ...
               _loc5_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_770,param1,param2,param3,param4));
         }
      }
      ...
      public function handleRoomObjectEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectStateChangeEvent.const_183:
            ...
            case RoomObjectDimmerStateUpdateEvent.const_60:
               ...
               break;
            case RoomObjectMoveEvent.const_536:
            ...
            case RoomObjectRoomAdEvent.const_376:
               ...
               break;
            case RoomObjectRoomActionEvent.const_401:
      ...
      private function handleRoomObjectMouseClick(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         switch(_loc4_)
         {
            ...
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               ...
               else
               {
                  ...
                  else if(_loc8_ == RoomObjectCategoryEnum.const_28 || _loc8_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_WALLITEM)
                  {
                     if(param1.ctrlKey)
                     {
         ...
         if(_loc8_ == RoomObjectCategoryEnum.const_71)
         {
            ...
            if(_loc14_ != _loc10_ && _loc15_ != _loc10_)
            {
               ...
               if(_loc16_ != null)
               {
                  _loc16_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_439,param2,param3,-1,RoomObjectCategoryEnum.const_151));
               }
         ...
         if(this._roomEngine != null)
         {
            ...
            if(_loc8_ != null && _loc8_.getEventHandler() != null)
            {
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc10_ = new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_469);
               }
               else
               {
      ...
      private function handleRoomObjectMouseDown(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               if(_loc8_ == RoomObjectCategoryEnum.const_28 || _loc8_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_WALLITEM)
               {
                  if(param1.altKey)
                  {
      ...
      private function handleObjectMove(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         if(_loc6_ != null)
         {
            ...
            else if(_loc5_.category == RoomObjectCategoryEnum.OBJECT_CATEGORY_WALLITEM)
            {
               _loc7_ = false;
      ...
      private function handleObjectPlace(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         if(_loc6_ == null)
         {
            ...
            else if(_loc5_.category == RoomObjectCategoryEnum.OBJECT_CATEGORY_WALLITEM && _loc9_ != null)
            {
            ...
            if(_loc5_.category == RoomObjectCategoryEnum.const_28)
            {
               if(_loc6_ != null)
               {
                  ...
                  {
                     _loc10_ = _loc6_.getModel().getNumberArray(RoomObjectVariableEnum.const_581);
      ...
      private function handleObjectSoundMachineEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectFurnitureActionEvent.ROOM_OBJECT_SOUND_MACHINE_START:
               this._roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_663));
               break;
            case RoomObjectFurnitureActionEvent.const_494:
               ...
               break;
            case RoomObjectFurnitureActionEvent.const_477:
               this._roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_430));
         }
      }
      ...
      private function handleObjectJukeboxEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectFurnitureActionEvent.const_496:
               this._roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_579));
               break;
            case RoomObjectFurnitureActionEvent.const_441:
               this._roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_430));
         }
      ...
      private function validateFurnitureLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:TileHeightMap) : Vector3d
      {
         ...
         var _loc8_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_325);
         if(_loc7_ < 1)
         {
            _loc7_ = 1;
         }
      ...
      private function validateWallItemLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Number, param6:Number, param7:SelectedRoomObjectData) : Vector3d
      {
         ...
         var _loc9_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_654);
      ...
      public function setSelectedAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var category:int = 0;
         var object:IRoomObjectController = this._roomEngine.getRoomObject(roomId,roomCategory,this.var_1180,category) as IRoomObjectController;
         ...
         if(selectionArrow != null && selectionArrow.getEventHandler() != null)
         {
            ...
            {
               selectionArrow.getEventHandler().processUpdateMessage(new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_469));
            }
            else
            {
      ...
      private function getValidFurnitureDirection(param1:IRoomObjectController, param2:Boolean) : int
      {
         ...
         {
            _loc3_ = param1.getModel().getNumberArray(RoomObjectVariableEnum.const_581);
         }
         ...
         switch(param5)
         {
            ...
            case RoomObjectOperationEnum.OBJECT_MOVE_TO:
               ...
               if(this._roomEngine.connection)
               {
                  ...
                  else if(param4 == RoomObjectCategoryEnum.OBJECT_CATEGORY_WALLITEM)
                  {
                     _loc9_ = int(_loc6_.getDirection().x) % 360;
                     ...
                     if(this._roomEngine.connection && _loc11_)
                     {
                        ...
                        {
                           this._roomEngine.connection.send(new PickupObjectMessageComposer(param3,param4));
                           this._roomEngine.connection.send(new PlaceObjectMessageComposer(param3,RoomObjectCategoryEnum.OBJECT_CATEGORY_WALLITEM,_loc12_,0,0,0));
                        }
                     }
                  }
               }
      ...
      private function placeObject(param1:int, param2:int) : void
      {
         ...
         if(this._roomEngine != null && this._roomEngine.connection != null)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               else if(_loc5_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_WALLITEM)
               {
               ...
               if(_loc5_ == RoomObjectCategoryEnum.const_34 && _loc3_.typeId == RoomObjectTypeEnum.const_256)
               {
         ...
         {
            this._roomEngine.events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_227,param1,param2,_loc4_,_loc5_));
         }
      }
      ...
      private function changeObjectState(param1:int, param2:int, param3:int, param4:String, param5:int, param6:Boolean) : void
      {
         ...
         if(this._roomEngine != null && this._roomEngine.connection != null)
         {
            ...
            else if(_loc7_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_WALLITEM)
            {
