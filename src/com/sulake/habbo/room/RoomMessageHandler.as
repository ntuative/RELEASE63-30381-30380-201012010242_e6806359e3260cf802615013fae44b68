package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_1764:Boolean = true;
      
      private var var_1357:int = -1.0E9;
            ...
            if(_loc2_.avatar != null)
            {
               ...
               switch(_loc9_.moveType)
               {
                  case SlideObjectMessageData.const_954:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_955:
                     _loc10_ = "std";
               }
