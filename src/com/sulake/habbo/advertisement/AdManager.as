package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1130:BitmapData = null;
      
      private var var_1128:BitmapData = null;
      ...
      {
         this.var_264 = param2 as IHabboCommunicationManager;
         if(this.var_264 == null)
         {
            return;
         }
         this._connection = this.var_264.getHabboMainConnection(this.onConnectionReady);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2544 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_2545 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2546 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1798 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1798 > 0 && this.var_1797 >= this.var_1798)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1129;
         if(_loc1_ > this.var_2545)
         {
            ++this.var_1797;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         if(this.var_1379 != "")
         {
            ...
            {
               this.var_209 = new Timer(this.var_2546,1);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_449,0,0,param1.bitmapData,this.var_2543));
            this.var_1129 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_414));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1380 = _loc2_.imageUrl;
         this.var_1799 = _loc2_.clickUrl;
         if(this.var_1380 != "" && this.var_1799 != "")
         {
            ...
            _loc4_ = new URLRequest(this.var_1380);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_515,0,0,_loc4_,this.var_1799,this.var_1130,this.var_1128));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1130 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1128 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
