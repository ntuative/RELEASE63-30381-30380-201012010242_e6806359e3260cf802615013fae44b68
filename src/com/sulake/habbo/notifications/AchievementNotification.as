package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1827:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this._window.center();
         this._badgeName = this.registerAchievementParameters("badge_name_" + this.var_269);
         this.var_2373 = this.registerAchievementParameters("badge_desc_" + this.var_269);
         this.var_2371 = this.registerAchievementParameters("badge_name_fb_" + this.var_269);
         this.var_2375 = this.registerAchievementParameters("badge_desc_fb_" + this.var_269);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2376 = this.registerTextParameters("notifications.text.achievement_facebook");
         this.var_2372 = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this._localizations.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_1421.toString());
         this._localizations.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1317.toString());
         this._localizations.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1317.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1680;
         var _loc17_:String = this.var_1680 == 0 ? "pixels" : "activitypoints";
         this._localizations.registerParameter(_loc16_,_loc17_,"" + this.var_2352);
         _loc15_.caption = this._localizations.getKey(_loc16_);
         this.setBadge(param13.getBadgeImage(param1),this.const_1550);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_1827) as BitmapDataAsset).content as BitmapData;
      ...
      {
         this._localizations.registerParameter(param1,"level",this.var_1681.toString());
         this._localizations.registerParameter(param1,"name",this.var_354.userName);
         return this._localizations.registerParameter(param1,"realname",this.var_354.realName);
      }
      ...
      private function registerTextParameters(param1:String) : String
      {
         ...
         this._localizations.registerParameter(param1,"badge_desc",this.var_2373);
         this._localizations.registerParameter(param1,"badge_name_fb",this.var_2371);
         this._localizations.registerParameter(param1,"badge_desc_fb",this.var_2375);
         this._localizations.registerParameter(param1,"level",this.var_1681.toString());
         this._localizations.registerParameter(param1,"name",this.var_354.userName);
         return this._localizations.registerParameter(param1,"realname",this.var_354.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_354.events.removeEventListener(BadgeImageReadyEvent.const_121,this.onBadgeImageReady);
            this.var_354 = null;
         }
         if(this._window != null)
         {
      ...
      {
         HabboWebTools.facebookAchievementPost(this.var_269,this.var_2372,this.var_2376,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2374));
