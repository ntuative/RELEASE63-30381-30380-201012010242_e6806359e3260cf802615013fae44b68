package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationViewManager implements IUpdateReceiver
   {
      ...
      private static const const_543:int = 4;
      ...
      public function showItem(param1:HabboNotificationItem) : void
      {
         ...
         var _loc2_:HabboNotificationItemView = new HabboNotificationItemView(this._assetLibrary.getAssetByName("layout_notification_xml"),this._windowManager,this.var_2181,this.var_368,this._toolbar);
      ...
      {
         return this.getNextAvailableVerticalPosition() + HabboNotificationItemView.const_574 < 540;
      }
      ...
      private function getNextAvailableVerticalPosition() : int
      {
         ...
         while(_loc2_ < this.var_194.length)
         {
            ...
            _loc1_ = _loc3_.verticalPosition + HabboNotificationItemView.const_574 + const_543;
            _loc2_++;
         }
         return _loc1_;
      }
