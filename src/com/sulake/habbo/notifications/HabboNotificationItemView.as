package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_517:int = 4;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_1506 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_1506 = 15;
         }
         this.var_1508 = this._window.height;
         this.var_656 = 4;
         this.var_657 = 0;
         this._state = name_1;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_427:
               this.var_975 += param1;
               _loc2_ = Number(this.var_975) / Number(this.var_368["time_fade_in"]);
               if(this.var_975 > int(this.var_368["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_832:
               ...
               if(this.var_1216 > int(this.var_368["time_display"]) && !this.var_1507)
               {
                  this.startFadeOut();
               }
               break;
            case const_831:
               this.var_974 += param1;
               _loc3_ = 1 - Number(this.var_974) / Number(this.var_368["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_974 > int(this.var_368["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1506;
         if(this._window.height < this.var_1508)
         {
            this._window.height = this.var_1508;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         if(this.var_368["position_horizontal_follow_toolbar"] == "true" && (this._toolbar.orientation != "TOP" && this._toolbar.orientation != "BOTTOM"))
         {
            ...
            {
               this._window.x = _loc5_ + const_517;
            }
            else
            {
               this._window.x = _loc6_ - this._window.width - const_517;
            }
         }
         ...
         if(this.var_368["position_vertical_follow_toolbar"] == "true" && (this._toolbar.orientation != "RIGHT" && this._toolbar.orientation != "LEFT"))
         {
            ...
            {
               this._window.y = _loc3_ + this.var_656;
            }
            else
            {
               this._window.y = _loc4_ - this._window.height - this.var_656;
            }
         }
      ...
      private function adjustBlend(param1:Number) : void
      {
         ...
         this._window.blend = this.var_657;
      }
   }
}
