package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2334:PseudoRandom;
      ...
      private var var_200:HabboHotelView;
      
      private var var_1298:String = "";
      
      private const const_1538:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_566 = param1;
            this.var_44.initConnection(HabboConnectionType.const_258);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_20.events.addEventListener(RoomSessionEvent.const_94,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      {
         if(this.var_44 && this.var_123 && this.var_20 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_200 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         var _loc1_:String = this.var_123.getKey("client.hotel_view.image");
         var _loc2_:String = this.var_123.getKey("image.library.url");
         if(_loc1_ != null && _loc2_ != null)
         {
            this.var_200.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_123.getKey("use.sso.ticket") == "1";
         this.var_566 = this.var_123.getKey("sso.ticket",null);
         this.var_1649 = this.var_123.getKey("flash.client.url","");
         this.var_2333 = this.var_123.getKey("external.variables.txt","");
         if(this.var_200 == null)
         {
            this.var_200 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_44.mode = HabboConnectionType.const_106;
            if(this.var_566)
            {
               this.var_44.initConnection(HabboConnectionType.const_258);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_450,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_44.mode = HabboConnectionType.const_1047;
            }
         }
         this.var_44.initConnection(HabboConnectionType.const_258);
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2334 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_44.mode)
         {
            case HabboConnectionType.const_106:
               _loc6_ = "";
               _loc6_ = this.var_123.getKey("url.prefix",_loc6_);
               _loc6_ = _loc6_.replace("http://","");
               _loc6_ = _loc6_.replace("https://","");
               _loc7_ = this.var_123.getKey("hotelview.banner.url","http:/\nsitename$/gamedata/banner");
               _loc7_ = _loc7_.replace("$sitename$",_loc6_);
               this.var_1298 = _loc4_;
               this.var_200.loadBannerImage(_loc7_ + "?token=" + this.var_1298,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1047:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1430:
               this.var_858 = this.generateRandomHexString(30);
               this.var_469 = new DiffieHellman(new BigInteger(this.var_123.getKey("connection.development.prime"),16),new BigInteger(this.var_123.getKey("connection.development.generator"),16));
               this.var_469.init(this.var_858);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2334);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1649,this.var_2333));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1538,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_566 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_566);
            _loc2_.send(_loc4_);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2335)
         {
            _loc2_ = this.var_123.getKey("logout.disconnect.url");
            if(this.var_123.keyExists("facebook.user"))
            {
      ...
      private function onDisconnectReason(param1:DisconnectReasonEvent) : void
      {
         ...
         this.var_2335 = true;
         var _loc2_:String = this.var_123.getKey("logout.url");
         if(_loc2_.length > 0)
         {
      ...
      private function setOriginProperty(param1:String) : String
      {
         ...
         {
            return param1.replace("%origin%",this.var_123.getKey("flash.client.origin","popup"));
         }
         return param1;
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1298);
