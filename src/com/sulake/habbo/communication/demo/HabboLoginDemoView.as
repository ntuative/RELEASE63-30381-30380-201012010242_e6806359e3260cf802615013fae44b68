package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_450:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_158.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_128,HabboWindowStyle.const_38,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1538,"/");
         if(_loc5_ != null)
         {
         ...
         {
            if(this.var_158.habboConfiguration.getKey("use.sso","false") == "true")
            {
               _loc8_.select();
            }
         }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1538,"/");
         ...
         {
            dispatchEvent(new Event(const_450));
         }
      }
      ...
      private function initSSOTicket() : void
      {
         ...
         {
            this.var_159.removeEventListener(SSOTicket.const_334,this.onParsedTicketSuccess);
            this.var_159.removeEventListener(SSOTicket.const_279,this.onParsedTicketFailure);
            this.var_159 = null;
         }
         var _loc1_:String = "";
         if(this.var_158.habboConfiguration != null)
         {
            _loc1_ = this.var_158.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = this.var_158.habboCommunication.habboWebLogin(this.name,this.password);
         this.var_159 = new SSOTicket(this.var_158.assets,_loc2_,_loc1_);
         this.var_159.addEventListener(SSOTicket.const_334,this.onParsedTicketSuccess);
         this.var_159.addEventListener(SSOTicket.const_279,this.onParsedTicketFailure);
      }
      
      private function onParsedTicketSuccess(param1:Event) : void
      {
         Logger.log("Got ticket: " + this.var_159.ticket);
         this.var_158.shockwaveClientUrl = this.var_159.shockwaveClientUrl;
         this.var_158.ssoTicket = this.var_159.ticket;
         this.var_159.removeEventListener(SSOTicket.const_334,this.onParsedTicketSuccess);
         this.var_159.removeEventListener(SSOTicket.const_279,this.onParsedTicketFailure);
         this.var_159 = null;
         dispatchEvent(new Event(const_450));
