package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1240:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1395:XML;
      
      private static var var_1396:XML;
       
      
      private var var_1825:Number = 4.294967295E9;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1395 == null)
         {
            ...
            var_1395 = _loc4_.content as XML;
         }
         if(var_1396 == null)
         {
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1825 == 4294967295)
            {
               this.var_1825 = _loc1_.color;
            }
            _loc1_.color = const_1240;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1470;
            }
         }
      }
      ...
      {
         this.var_51 = navigator.catalog.windowManager.buildFromXML(var_1396) as IItemListWindow;
         if(this.var_51 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1395) as IWindowContainer;
         }
         else
         {
