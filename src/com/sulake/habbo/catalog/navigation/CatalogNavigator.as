package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2657:String = "magic.credits";
      
      private var var_2614:String = "magic.pixels";
      
      private var var_2615:String = "catalog.page.club";
      ...
      {
         this.openPage(this.var_2614);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2615,true);
      }
