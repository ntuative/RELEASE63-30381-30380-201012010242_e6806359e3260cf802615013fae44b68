package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - this.var_1141,(param2 - this.var_919) / 2));
         return _loc3_;
      }
      
      private function getX(param1:int) : Number
      {
         return this.var_1141 + this.var_1141 / -this.var_2640 * this._x[param1];
      }
      
      private function getY(param1:int) : Number
      {
         return this.var_919 - this.var_919 / this.var_615 * this.var_165[param1];
      }
