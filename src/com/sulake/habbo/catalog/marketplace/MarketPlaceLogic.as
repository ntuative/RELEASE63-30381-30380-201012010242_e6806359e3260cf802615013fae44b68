package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1588:int = 2;
      
      public const const_1834:int = 3;
      ...
      private var var_2560:MarketplaceItemStats;
      ...
      {
         this.requestOffers(this.var_2558,this.var_2561,this.var_2408,this.var_2559);
      }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_1910 = _loc3_.creditsWaiting;
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            this.showConfirmation(this.const_1588,updateItem);
            this._visualization.listUpdatedNotify();
         }
      ...
      {
         if(param1.furniCategoryId != this.var_2216 || param1.furniTypeId != this.var_2219)
         {
            return;
         }
      ...
      private function isPosterItem(param1:MarketPlaceOfferData) : Boolean
      {
         ...
         if(param1.furniType == 2 && param1.stuffData != null)
         {
            ...
            {
               _loc4_ = _loc3_.name;
               if(_loc4_ != null && _loc4_ == const_1144)
               {
                  _loc2_ = true;
               }
            }
