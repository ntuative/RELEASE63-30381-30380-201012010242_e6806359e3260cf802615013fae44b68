package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1560:uint = 4.293848814E9;
      
      private const const_1561:uint = 4.294967295E9;
      ...
      private function updateLocalizations() : void
      {
         ...
         var _loc8_:String = this.var_83.activityPointType == Purse.const_478 ? "pixels" : "activitypoints";
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1594 = _loc1_.stuffTypes;
            this.var_700 = _loc1_.boxTypes;
            this.var_701 = _loc1_.ribbonTypes;
            this.var_1076 = this.var_1594[0];
            this.var_324 = this.var_700[0];
            this.var_325 = this.var_701[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_325 < 0)
         {
            this.var_325 = this.var_701.length - 1;
         }
         if(this.var_325 > this.var_701.length - 1)
         {
            this.var_325 = 0;
         }
         if(this.var_324 < 0)
         {
            this.var_324 = this.var_700.length - 1;
         }
         if(this.var_324 > this.var_700.length - 1)
         {
            this.var_324 = 0;
         }
         var _loc1_:int = this.var_700[this.var_324] * 1000 + this.var_701[this.var_325];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_83.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1076,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1316 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1594;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1076);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_700[this.var_324]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_701[this.var_325]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_83,this.var_1315,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_83.offerId,this.var_1315);
               this.dispose();
               break;
            case "cancel_button":
         ...
         switch(param1.type)
         {
            case WindowEvent.const_104:
               ...
               for each(_loc7_ in this.var_207)
               {
                  ...
                  if(_loc5_.length >= this.const_1825)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2370 = _loc3_.text;
               break;
            case WindowMouseEvent.const_40:
               ...
               break;
            case WindowKeyboardEvent.const_615:
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_239 == null || this.var_572 == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(this.const_1560) : uint(this.const_1561);
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1076;
               }
            }
            _loc4_++;
         }
