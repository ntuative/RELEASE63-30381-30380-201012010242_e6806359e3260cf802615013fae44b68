package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1507:String = "ctlg_";
      ...
      private var var_1096:ICatalogViewer;
      ...
      private var var_1189:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1190:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_1189 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_948);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_948);
      }
      ...
      {
         var _loc2_:String = const_1507 + param1;
      ...
      private function createWidgets() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_1190 = new ItemGridCatalogWidget(_loc1_);
            this.var_58.push(this.var_1190);
         }
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1297) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_58.push(new ColourGridCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1477) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1505) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1434) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1366) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1347) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1241) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = this.var_1189;
            _loc2_.init();
         }
         this.var_1189.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         return this.var_1189.dispatchEvent(param1);
      }
   }
}
