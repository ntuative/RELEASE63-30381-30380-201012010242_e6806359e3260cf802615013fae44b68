package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      protected var var_291:IGridItem;
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_757,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_288,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_775,this.deActivateScrollbar);
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         if(param1.pricingModel == Offer.const_437)
         {
            ++this.var_1786;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1786);
         }
      }
