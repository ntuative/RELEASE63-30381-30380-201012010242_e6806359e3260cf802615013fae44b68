package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_302:BitmapData = null;
      ...
      override public function init() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_169 = _loc1_.content as XML;
            for each(_loc2_ in page.offers)
            {
               ...
               {
                  case "floor":
                     for each(_loc9_ in this.var_169.floors.pattern)
                     {
                        this._activeFloorPatterns.push(String(_loc9_.@id));
                        this.var_1204.push(_loc2_);
                     }
                     break;
                  case "wallpaper":
                     for each(_loc10_ in this.var_169.walls.pattern)
                     {
                     ...
                     break;
                  case "landscape":
                     for each(_loc11_ in this.var_169.landscapes.pattern)
                     {
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1205[this.var_356];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1204[this.var_358];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this.var_1206[this.var_357];
               if(_loc3_ != null)
               {
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc2_:String = this.var_787[this.var_356];
         for each(_loc1_ in this.var_169.walls.pattern)
         {
            if(_loc1_.@id == _loc2_)
            {
               if(this.var_355 >= 0)
         ...
         var _loc5_:String = this._activeFloorPatterns[this.var_358];
         for each(_loc1_ in this.var_169.floors.pattern)
         {
            if(_loc1_.@id == _loc5_)
            {
               _loc11_ = _loc1_.children()[this.var_430];
               if(_loc11_ != null)
               {
         ...
         _loc6_ = this.var_1204[this.var_358];
         if(_loc6_ != null)
         {
         ...
         var _loc7_:String = this.var_791[this.var_357];
         for each(_loc1_ in this.var_169.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               _loc13_ = _loc1_.children()[this.var_429];
               if(_loc13_ != null)
               {
         ...
         _loc8_ = this.var_1206[this.var_357];
         if(_loc8_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_190:
               ...
               if(this.var_356 < 0)
               {
                  this.var_356 = this.var_787.length - 1;
               }
               if(this.var_356 == this.var_787.length)
               {
                  this.var_356 = 0;
               }
               this.var_355 = 0;
               this.var_789 = 0;
               _loc5_ = this.var_787[this.var_356];
               for each(_loc8_ in this.var_169.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     this.var_789 = _loc8_.children().length();
                  }
               }
            ...
            case const_191:
               ...
               if(this.var_358 < 0)
               {
                  this.var_358 = this._activeFloorPatterns.length - 1;
               }
               if(this.var_358 >= this._activeFloorPatterns.length)
               {
                  this.var_358 = 0;
               }
               this.var_430 = 0;
               this.var_790 = 0;
               _loc6_ = this._activeFloorPatterns[this.var_358];
               for each(_loc9_ in this.var_169.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     this.var_790 = _loc9_.children().length();
                  }
               }
            ...
            case const_93:
               ...
               if(this.var_357 < 0)
               {
                  this.var_357 = this.var_791.length - 1;
               }
               if(this.var_357 >= this.var_791.length)
               {
                  this.var_357 = 0;
               }
               this.var_429 = 0;
               this.var_788 = 0;
               _loc7_ = this.var_791[this.var_357];
               for each(_loc10_ in this.var_169.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     this.var_788 = _loc10_.children().length();
                  }
               }
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(this.var_302 != null && this.var_301 != null)
         {
            this.setRoomImage(this.var_302,this.var_301);
         }
      }
   }
}
