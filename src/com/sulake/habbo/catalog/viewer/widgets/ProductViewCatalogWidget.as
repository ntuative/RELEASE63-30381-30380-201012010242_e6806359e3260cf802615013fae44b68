package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1296:IScrollbarWindow;
      ...
      override public function init() : void
      {
         ...
         this.var_1057 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_81 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1644 = new Point(this.var_81.x,this.var_81.y);
         this.var_468 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1296 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1643 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_468 != null)
         {
            this.var_468.visible = false;
            this.var_468.destroyGridItems();
         }
         ...
         this.var_1057.text = _loc5_;
         this.var_857.height = this.var_857.textHeight + 5;
         this.var_1057.y = this.var_857.y + this.var_857.height;
         this.var_1057.height = Math.max(130,this.var_1057.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_437:
                  _loc6_ = this.var_1643.clone();
                  if(this.var_468 != null)
                  {
                     this.var_468.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_468,this.var_1296,this.var_1723);
                     this.var_468.scrollV = 0;
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_257:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_296,AvatarAction.const_523);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2318)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2318 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_81 != null && true)
         {
            ...
            this.var_81.x = this.var_1644.x;
            this.var_81.y = this.var_1644.y;
            if(param3 != null)
            {
