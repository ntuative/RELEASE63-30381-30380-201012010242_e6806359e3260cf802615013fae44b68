   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      override public function init() : void
      {
         ...
         for each(_loc3_ in page.offers)
         {
            ...
            if(this.var_383.getValue(_loc5_) == null)
            {
               this.var_383.add(_loc5_,new Map());
            }
            _loc7_ = this.var_383.getValue(_loc5_) as Map;
            _loc7_.add(_loc6_,_loc3_);
         }
         _loc4_ = this.var_383.getWithIndex(this.var_267);
         if(_loc4_ != null)
         {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc2_:Map = this.var_383.getWithIndex(this.var_267);
         if(_loc2_ != null)
         {
      ...
      private function onClickNext(param1:WindowMouseEvent) : void
      {
         var _loc3_:* = null;
         ++this.var_267;
         if(this.var_267 >= this.var_383.length)
         {
            this.var_267 = 0;
         }
         var _loc2_:Map = this.var_383.getWithIndex(this.var_267);
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_267 < 0)
         {
            this.var_267 = this.var_383.length - 1;
         }
         var _loc2_:Map = this.var_383.getWithIndex(this.var_267);
         if(_loc2_ != null)
         {
