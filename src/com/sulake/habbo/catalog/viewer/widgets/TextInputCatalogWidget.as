package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         super.init();
         this.var_951 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(this.var_951 != null)
         {
            this.var_951.addEventListener(WindowKeyboardEvent.const_615,this.onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(this.var_951.text));
      }
   }
}
