package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_293:ICatalogNavigator;
      ...
      private var var_1920:GiftWrappingConfiguration;
      
      private var var_934:ClubGiftController;
      
      private var var_419:ClubBuyController;
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "") : void
      {
         ...
         {
            this.var_419.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_293.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      {
         return this.var_354.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_354.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_80)
         {
            _loc3_ = this.var_354.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_102.getActivityPointsForType(Purse.const_478)));
         var _loc1_:int = 0;
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_628)
         {
            if(!this.var_354.loadProductData(this))
            {
               return;
            }
            this.init();
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_293 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_84:
               this.var_1423 = param1.session.isPrivateRoom;
               if(this.var_85 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_934 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_419 == null)
         {
            this.var_419 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_293.buildCatalogIndex(_loc2_);
         if(this.var_627 && this.var_627 != "")
         {
            this.var_293.openPage(this.var_627);
            this.var_627 = "";
            this.var_768 = -1;
         }
         else if(this.var_768 > -1)
         {
            this.var_293.openPageById(this.var_768,this.var_1424);
            this.var_768 = -1;
            this.var_1424 = -1;
            this.var_627 = "";
         }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_1921 && this.var_516 != null)
         {
            this.var_516.playSound(HabboSoundTypesEnum.const_1027);
         }
         this.var_1921 = false;
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_1922 && this.var_516 != null)
         {
            this.var_516.playSound(HabboSoundTypesEnum.const_1041);
         }
         this.var_1922 = false;
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_102.clubDays = Math.max(0,_loc2_.method_2);
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_934.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_1920 = new GiftWrappingConfiguration(param1);
      }
