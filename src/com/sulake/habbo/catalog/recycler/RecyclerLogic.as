package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_586 != const_871;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1701 != RecyclerStatusMessageEvent.const_1101;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_586 == const_391;
      }
      ...
      {
         this.var_586 = const_872;
         this.var_112 = new Array(const_181);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1450:
               this.var_586 = const_391;
               if(this._view == null)
               {
                  return;
            ...
            case RecyclerStatusMessageEvent.const_1101:
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1411:
               if(this._view == null)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_912:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1466:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_112.length < const_181)
         {
            return false;
         }
         var _loc1_:int = 0;
