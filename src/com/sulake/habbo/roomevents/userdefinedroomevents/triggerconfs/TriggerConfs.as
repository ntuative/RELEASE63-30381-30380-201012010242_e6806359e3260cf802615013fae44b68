package com.sulake.habbo.roomevents.userdefinedroomevents.triggerconfs
{
   ...
   public class TriggerConfs implements ElementTypeHolder
   {
      ...
      public function TriggerConfs()
      {
         ...
         super();
         this.var_217.push(new AvatarSaysSomething());
         this.var_217.push(new AvatarEntersStuff());
         this.var_217.push(new AvatarExitsStuff());
         this.var_217.push(new TriggerOnce());
         this.var_217.push(new StuffIsUsed());
         this.var_217.push(new TriggerPeriodically());
         this.var_217.push(new AvatarEntersRoom());
         this.var_217.push(new GameStarts());
         this.var_217.push(new GameEnds());
         this.var_217.push(new ScoreAchieved());
      }
