package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_1093:IContainerButtonWindow;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1715 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1093 = this.var_1715.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1093)
         {
            this.var_1093.procedure = this.onButtonClick;
         }
         this.var_1092 = this.var_1715.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1092)
         {
