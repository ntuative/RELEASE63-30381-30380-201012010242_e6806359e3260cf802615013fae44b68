package com.sulake.habbo.roomevents.userdefinedroomevents.actiontypes
{
   ...
   public class GiveScore implements ActionType
   {
      ...
      private var var_968:SliderWindowController;
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_967.getValue());
         _loc2_.push(this.var_968.getValue());
         return _loc2_;
      }
      ...
      {
         this.var_87 = param2;
         this.var_967 = new SliderWindowController(param2,this.getInput(param1),param2.assets,1,100,1);
         this.var_967.addEventListener(Event.CHANGE,this.onSliderChange);
         this.var_967.setValue(1);
         this.var_968 = new SliderWindowController(param2,this.getCounterInput(param1),param2.assets,1,10,1);
         this.var_968.addEventListener(Event.CHANGE,this.onCounterSliderChange);
         this.var_968.setValue(1);
      }
      ...
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         ...
         this.var_967.setValue(_loc3_);
         this.var_968.setValue(_loc4_);
      }
