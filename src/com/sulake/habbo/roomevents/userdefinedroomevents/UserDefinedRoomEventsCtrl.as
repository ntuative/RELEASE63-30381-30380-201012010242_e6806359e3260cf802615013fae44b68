package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private var var_1434:TriggerConfs;
      
      private var var_1435:ActionTypes;
      
      private var var_1436:ConditionTypes;
      
      private var var_219:Dictionary;
      
      private var var_57:Triggerable;
      
      private var var_633:RoomObjectHightLighter;
      
      private var var_168:UserDefinedRoomEventsHelp;
      
      private var var_939:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1434 = new TriggerConfs();
         this.var_1435 = new ActionTypes();
         this.var_1436 = new ConditionTypes();
         this.var_219 = new Dictionary();
         super();
         this.var_87 = param1;
         this.var_633 = new RoomObjectHightLighter(param1);
         this.var_168 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         {
            delete this.var_219[param1];
            this.var_633.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_57.furniLimit)
         {
            this.var_219[param1] = param2;
            this.var_633.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_939 = new SliderWindowController(this.var_87,IWindowContainer(this.find(this.var_86,"delay_slider_container")),this.var_87.assets,0,20,1);
         this.var_939.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_939.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_633.hideAll(this.var_219);
         }
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_939.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_168.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1434);
         this.refreshConfigureElement(this.var_1435);
         this.refreshConfigureElement(this.var_1436);
