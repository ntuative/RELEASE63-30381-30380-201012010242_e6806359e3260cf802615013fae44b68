package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      {
         if(param1 != this.var_1458 || param2 != this.var_1459)
         {
      ...
      {
         if(this.var_1196 > 255 || bitmapData == null)
         {
            return false;
         }
