package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_125:Sprite;
      
      private var var_54:Sprite;
      
      private var var_577:Map;
      
      private var var_477:Point;
      
      private var var_241:BitmapDataCache;
      
      private var var_574:RoomObjectCache;
      
      private var var_476:Array;
      
      private var var_575:Array;
      
      private var var_1318:IRoomRenderingCanvasMouseListener = null;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_240.addChild(this.var_54);
         ...
         this.var_574 = new RoomObjectCache(_loc6_);
      ...
      {
         this.var_477.x -= param1 - this.var_573;
         this.var_573 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_477.y -= param1 - this.var_576;
         this.var_576 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_775 = true;
            if(this.var_125 != null && !this.var_240.contains(this.var_125))
            {
               this.var_240.addChild(this.var_125);
               this.var_54.mask = this.var_125;
            }
         }
         else if(!param1 && this.var_775)
         {
            this.var_775 = false;
            if(this.var_125 != null && this.var_240.contains(this.var_125))
            {
               this.var_240.removeChild(this.var_125);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_575 != null)
         {
            ...
            {
               this.cleanSprite(this.var_575[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_575 = [];
         }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(this.var_125 != null)
         {
            this.var_125.graphics.clear();
         }
         else
         {
            this.var_125 = new Sprite();
            this.var_125.name = "mask";
            if(this.var_775)
            {
               this.var_240.addChild(this.var_125);
               this.var_54.mask = this.var_125;
         ...
         this.var_125.graphics.beginFill(0);
         this.var_125.graphics.drawRect(0,0,param1,param2);
         this.var_703 = param1;
         this._ht = param2;
      }
      ...
      {
         this.var_574.removeObjectCache(param1);
      }
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_703 != this.var_2381 || this._ht != this.var_2379)
         {
            _loc9_ = true;
         }
         if(this.var_54.x != this.var_573 || this.var_54.y != this.var_576)
         {
            this.var_54.x = this.var_573;
            this.var_54.y = this.var_576;
            _loc9_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_476.sortOn("z",0 | 0);
         if(_loc5_ < this.var_476.length)
         {
            this.var_476.splice(_loc5_);
         }
         var _loc10_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc10_ = this.var_476[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
         ...
         this.var_2381 = this.var_703;
         this.var_2379 = this._ht;
      }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_574.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_574.getObjectCache(param2);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_575.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_476.length)
         {
            return null;
         }
         return this.var_476[param1] as SortableSprite;
      }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_573;
         param2 -= this.var_576;
         this.var_477.x = param1;
         this.var_477.y = param2;
         if(this.var_1077 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1682;
         }
         this.var_1682 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1077;
         return this.var_1682;
      }
      ...
      private function createMouseEvent(param1:int, param2:int, param3:int, param4:int, param5:String, param6:String, param7:Boolean, param8:Boolean, param9:Boolean, param10:Boolean) : RoomSpriteMouseEvent
      {
         ...
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1683,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_577.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_577.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2380 || param2 != this.var_2378)
                     {
                        this.method_3(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_577.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_577.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.method_3(_loc11_,_loc9_);
      ...
      private function method_3(param1:RoomSpriteMouseEvent, param2:String) : void
      {
         ...
         while(_loc1_ < this.var_327.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1318.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1077 == 0)
         {
            this.checkMouseHits(this.var_477.x,this.var_477.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1077 = 0;
         ++this.var_1683;
      }
