package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_685:Number = 64;
      ...
      private var var_2624:Number = -500.0;
      
      private var var_2623:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1081 = new Vector3d();
         this.var_1689 = 1;
         this.var_1690 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1688 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_76.x * this.var_392,this.var_76.y * this.var_393,this.var_76.z * this.var_391);
      }
      ...
      {
         if(this.var_392 != param1 * this.var_1689)
         {
            this.var_392 = param1 * this.var_1689;
            ++this.var_144;
         }
      }
      ...
      {
         if(this.var_393 != param1 * this.var_1690)
         {
            this.var_393 = param1 * this.var_1690;
            ++this.var_144;
         }
      }
      ...
      {
         if(this.var_391 != param1 * this.var_1688)
         {
            this.var_391 = param1 * this.var_1688;
            ++this.var_144;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_76.y /= this.var_393;
         this.var_76.z /= this.var_391;
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1081.assign(_loc22_);
         }
         else
         {
            this.var_1081.assign(_loc17_);
         }
         ++this.var_144;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1081);
         if(_loc3_ < this.var_2624 || _loc3_ > this.var_2623)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_393;
            _loc2_.z *= this.var_391;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1081);
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_76.x * this.var_392,this.var_76.y * this.var_393,this.var_76.z * this.var_391);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_164;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_392,param2.y * this.var_393,param2.z * this.var_391);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_392,param3.y * this.var_393,param3.z * this.var_391);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_392,param4.y * this.var_393,param4.z * this.var_391);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_894;
         }
         else
         {
            this.scale = const_685;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_685;
      }
