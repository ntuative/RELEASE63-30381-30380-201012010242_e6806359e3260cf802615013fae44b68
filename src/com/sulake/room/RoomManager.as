package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_949:int = 2;
      ...
      private var var_2662:IRoomContentLoader;
      ...
      {
         var _loc1_:* = null;
         if(this.var_568 == null || this.var_474 == null)
         {
            return;
         }
         this._state = const_1421;
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_570.indexOf(_loc5_) < 0)
            {
               this.var_46.loadObjectContent(_loc5_,events);
               this.var_570.push(_loc5_);
            }
            _loc4_++;
         }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_724)
         {
            return;
         }
         if(this.var_46 == null)
         {
            this._state = const_724;
            return;
         }
         if(this.var_46.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_570.indexOf(param1);
            if(_loc2_ >= 0)
            {
      ...
      private function updateObjectContent(param1:String) : void
      {
         ...
         if(this.var_46 == null || this.var_474 == null)
         {
            return;
         }
